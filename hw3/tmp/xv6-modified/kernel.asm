...
8010123a:	e8 91 32 00 00       	call   801044d0 <acquire>
...
8010129f:	e8 ec 32 00 00       	call   80104590 <release>
...
801012ca:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012cd:	e8 be 32 00 00       	call   80104590 <release>
      return ip;
...
801014a6:	e8 e5 2e 00 00       	call   80104390 <initlock>
...
8010166f:	e8 5c 2e 00 00       	call   801044d0 <acquire>
  ip->ref++;
80101674:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101678:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010167f:	e8 0c 2f 00 00       	call   80104590 <release>
}
...
801017f6:	e8 d5 2c 00 00       	call   801044d0 <acquire>
  ip->ref--;
...
8010180f:	5d                   	pop    %ebp
  release(&icache.lock);
80101810:	e9 7b 2d 00 00       	jmp    80104590 <release>
80101815:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101818:	83 ec 0c             	sub    $0xc,%esp
8010181b:	68 e0 09 11 80       	push   $0x801109e0
80101820:	e8 ab 2c 00 00       	call   801044d0 <acquire>
    int r = ip->ref;
80101825:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101828:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010182f:	e8 5c 2d 00 00       	call   80104590 <release>
    if(r == 1){
...
80101c99:	e8 32 28 00 00       	call   801044d0 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101ca9:	e8 e2 28 00 00       	call   80104590 <release>
...
80101ed8:	68 fa 78 10 80       	push   $0x801078fa
...
80103674:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
	release(&ptable.lock);
8010367a:	e8 11 0f 00 00       	call   80104590 <release>
...
8010369c:	89 53 18             	mov    %edx,0x18(%ebx)
	*(uint*)sp = (uint)trapret;
8010369f:	c7 40 14 fb 58 10 80 	movl   $0x801058fb,0x14(%eax)
	p->context = (struct context*)sp;
...
801036ae:	e8 2d 0f 00 00       	call   801045e0 <memset>
...
801036da:	e8 b1 0e 00 00       	call   80104590 <release>
}
...
8010370b:	e8 80 0e 00 00       	call   80104590 <release>
...
80103756:	68 d5 76 10 80       	push   $0x801076d5
8010375b:	68 20 2d 11 80       	push   $0x80112d20
80103760:	e8 2b 0c 00 00       	call   80104390 <initlock>
}
...
80103814:	83 ec 04             	sub    $0x4,%esp
	pushcli();
80103817:	e8 e4 0b 00 00       	call   80104400 <pushcli>
	c = mycpu();
8010381c:	e8 4f ff ff ff       	call   80103770 <mycpu>
	p = c->proc;
80103821:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
80103827:	e8 14 0c 00 00       	call   80104440 <popcli>
}
...
80103853:	e8 78 36 00 00       	call   80106ed0 <setupkvm>
...
80103871:	e8 3a 33 00 00       	call   80106bb0 <inituvm>
...
80103886:	e8 55 0d 00 00       	call   801045e0 <memset>
...
801038df:	68 05 77 10 80       	push   $0x80107705
801038e4:	50                   	push   %eax
801038e5:	e8 d6 0e 00 00       	call   801047c0 <safestrcpy>
	p->cwd = namei("/");
801038ea:	c7 04 24 0e 77 10 80 	movl   $0x8010770e,(%esp)
...
80103923:	68 ec 76 10 80       	push   $0x801076ec
...
80103935:	8b 75 08             	mov    0x8(%ebp),%esi
	pushcli();
80103938:	e8 c3 0a 00 00       	call   80104400 <pushcli>
	c = mycpu();
8010393d:	e8 2e fe ff ff       	call   80103770 <mycpu>
	p = c->proc;
80103942:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
80103948:	e8 f3 0a 00 00       	call   80104440 <popcli>
	if(n > 0){
...
8010395c:	e8 3f 31 00 00       	call   80106aa0 <switchuvm>
	return 0;
...
8010397a:	e8 71 33 00 00       	call   80106cf0 <allocuvm>
...
8010399a:	e8 81 34 00 00       	call   80106e20 <deallocuvm>
...
801039b6:	83 ec 1c             	sub    $0x1c,%esp
	pushcli();
801039b9:	e8 42 0a 00 00       	call   80104400 <pushcli>
	c = mycpu();
801039be:	e8 ad fd ff ff       	call   80103770 <mycpu>
	p = c->proc;
801039c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
801039c9:	e8 72 0a 00 00       	call   80104440 <popcli>
	if((np = allocproc()) == 0){
...
801039e8:	e8 b3 35 00 00       	call   80106fa0 <copyuvm>
...
80103a61:	e8 5a 0d 00 00       	call   801047c0 <safestrcpy>
	pid = np->pid;
80103a66:	8b 5f 10             	mov    0x10(%edi),%ebx
	acquire(&ptable.lock);
80103a69:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a70:	e8 5b 0a 00 00       	call   801044d0 <acquire>
	np->state = RUNNABLE;
...
80103afe:	e8 cd 09 00 00       	call   801044d0 <acquire>
...
80103b20:	e8 7b 2f 00 00       	call   80106aa0 <switchuvm>
...
80103b2b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
			swtch(&(c->scheduler), p->context);
80103b32:	e8 e4 0c 00 00       	call   8010481b <swtch>
			switchkvm();
80103b37:	e8 44 2f 00 00       	call   80106a80 <switchkvm>
			c->proc = 0;
80103b3c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b43:	00 00 00 
80103b46:	83 c4 10             	add    $0x10,%esp
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b49:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103b4f:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103b55:	72 b9                	jb     80103b10 <scheduler+0x40>
		release(&ptable.lock);
80103b57:	83 ec 0c             	sub    $0xc,%esp
80103b5a:	68 20 2d 11 80       	push   $0x80112d20
80103b5f:	e8 2c 0a 00 00       	call   80104590 <release>
		sti();
...
80103b74:	53                   	push   %ebx
	pushcli();
80103b75:	e8 86 08 00 00       	call   80104400 <pushcli>
	c = mycpu();
80103b7a:	e8 f1 fb ff ff       	call   80103770 <mycpu>
	p = c->proc;
80103b7f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
80103b85:	e8 b6 08 00 00       	call   80104440 <popcli>
	if(!holding(&ptable.lock))
80103b8a:	83 ec 0c             	sub    $0xc,%esp
80103b8d:	68 20 2d 11 80       	push   $0x80112d20
80103b92:	e8 09 09 00 00       	call   801044a0 <holding>
80103b97:	83 c4 10             	add    $0x10,%esp
80103b9a:	85 c0                	test   %eax,%eax
80103b9c:	74 53                	je     80103bf1 <sched+0x81>
	if(mycpu()->ncli != 1)
80103b9e:	e8 cd fb ff ff       	call   80103770 <mycpu>
80103ba3:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103baa:	75 6c                	jne    80103c18 <sched+0xa8>
	if(p->state == RUNNING)
80103bac:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103bb0:	74 59                	je     80103c0b <sched+0x9b>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103bb2:	9c                   	pushf  
80103bb3:	58                   	pop    %eax
	if(readeflags()&FL_IF)
80103bb4:	f6 c4 02             	test   $0x2,%ah
80103bb7:	75 45                	jne    80103bfe <sched+0x8e>
	intena = mycpu()->intena;
80103bb9:	e8 b2 fb ff ff       	call   80103770 <mycpu>
80103bbe:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
	swtch(&p->context, mycpu()->scheduler);
80103bc4:	e8 a7 fb ff ff       	call   80103770 <mycpu>
80103bc9:	83 ec 08             	sub    $0x8,%esp
80103bcc:	ff 70 04             	pushl  0x4(%eax)
80103bcf:	8d 43 1c             	lea    0x1c(%ebx),%eax
80103bd2:	50                   	push   %eax
80103bd3:	e8 43 0c 00 00       	call   8010481b <swtch>
			p->ctsw_cnt++;
80103bd8:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
	mycpu()->intena = intena;
80103bdc:	e8 8f fb ff ff       	call   80103770 <mycpu>
}
80103be1:	83 c4 10             	add    $0x10,%esp
	mycpu()->intena = intena;
80103be4:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
80103bea:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103bed:	5b                   	pop    %ebx
80103bee:	5e                   	pop    %esi
80103bef:	5d                   	pop    %ebp
80103bf0:	c3                   	ret    
...
80103bf4:	68 10 77 10 80       	push   $0x80107710
80103bf9:	e8 92 c7 ff ff       	call   80100390 <panic>
		panic("sched interruptible");
80103bfe:	83 ec 0c             	sub    $0xc,%esp
80103c01:	68 3c 77 10 80       	push   $0x8010773c
80103c06:	e8 85 c7 ff ff       	call   80100390 <panic>
		panic("sched running");
80103c0b:	83 ec 0c             	sub    $0xc,%esp
80103c0e:	68 2e 77 10 80       	push   $0x8010772e
80103c13:	e8 78 c7 ff ff       	call   80100390 <panic>
		panic("sched locks");
80103c18:	83 ec 0c             	sub    $0xc,%esp
80103c1b:	68 22 77 10 80       	push   $0x80107722
80103c20:	e8 6b c7 ff ff       	call   80100390 <panic>
...
80103c36:	83 ec 0c             	sub    $0xc,%esp
	pushcli();
80103c39:	e8 c2 07 00 00       	call   80104400 <pushcli>
	c = mycpu();
80103c3e:	e8 2d fb ff ff       	call   80103770 <mycpu>
	p = c->proc;
80103c43:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
	popcli();
80103c49:	e8 f2 07 00 00       	call   80104440 <popcli>
	if(curproc == initproc)
...
80103ca2:	e8 29 08 00 00       	call   801044d0 <acquire>
...
80103d47:	68 5d 77 10 80       	push   $0x8010775d
80103d4c:	e8 3f c6 ff ff       	call   80100390 <panic>
		panic("init exiting");
80103d51:	83 ec 0c             	sub    $0xc,%esp
80103d54:	68 50 77 10 80       	push   $0x80107750
...
80103d6c:	e8 5f 07 00 00       	call   801044d0 <acquire>
	pushcli();
...
80103df0:	e8 db 06 00 00       	call   801044d0 <acquire>
		release(lk);
...
80103e2b:	5d                   	pop    %ebp
		acquire(lk);
80103e2c:	e9 9f 06 00 00       	jmp    801044d0 <acquire>
...
80103e59:	68 6f 77 10 80       	push   $0x8010776f
80103e5e:	e8 2d c5 ff ff       	call   80100390 <panic>
		panic("sleep");
80103e63:	83 ec 0c             	sub    $0xc,%esp
80103e66:	68 69 77 10 80       	push   $0x80107769
...
80103f0a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
				freevm(p->pgdir);
80103f11:	e8 3a 2f 00 00       	call   80106e50 <freevm>
				release(&ptable.lock);
...
80103f36:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
				release(&ptable.lock);
80103f3d:	e8 4e 06 00 00       	call   80104590 <release>
				return pid;
...
80103f5b:	e8 30 06 00 00       	call   80104590 <release>
			return -1;
...
80103f7f:	e8 4c 05 00 00       	call   801044d0 <acquire>
...
80103f95:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103fa7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fae:	05 84 00 00 00       	add    $0x84,%eax
80103fb3:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103fc4:	c9                   	leave  
	release(&ptable.lock);
80103fc5:	e9 c6 05 00 00       	jmp    80104590 <release>
...
80103fdf:	e8 ec 04 00 00       	call   801044d0 <acquire>
...
8010401d:	e8 6e 05 00 00       	call   80104590 <release>
			return 0;
...
80104038:	e8 53 05 00 00       	call   80104590 <release>
	return -1;
...
8010406b:	68 27 7b 10 80       	push   $0x80107b27
...
80104091:	83 f8 05             	cmp    $0x5,%eax
			state = "???";
80104094:	ba 80 77 10 80       	mov    $0x80107780,%edx
		if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104099:	77 11                	ja     801040ac <procdump+0x5c>
8010409b:	8b 14 85 e0 77 10 80 	mov    -0x7fef8820(,%eax,4),%edx
			state = "???";
801040a2:	b8 80 77 10 80       	mov    $0x80107780,%eax
...
801040b4:	68 84 77 10 80       	push   $0x80107784
...
801040db:	e8 d0 02 00 00       	call   801043b0 <getcallerpcs>
...
801040f9:	68 c1 71 10 80       	push   $0x801071c1
...
8010412e:	e8 9d 03 00 00       	call   801044d0 <acquire>
...
80104144:	83 db ff             	sbb    $0xffffffff,%ebx
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104147:	81 c2 84 00 00 00    	add    $0x84,%edx
8010414d:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104153:	72 eb                	jb     80104140 <get_num_proc+0x20>
	}
	release(&ptable.lock);
80104155:	83 ec 0c             	sub    $0xc,%esp
80104158:	68 20 2d 11 80       	push   $0x80112d20
8010415d:	e8 2e 04 00 00       	call   80104590 <release>
...
8010417e:	e8 4d 03 00 00       	call   801044d0 <acquire>
...
80104190:	8b 42 10             	mov    0x10(%edx),%eax
80104193:	39 c3                	cmp    %eax,%ebx
80104195:	0f 4c d8             	cmovl  %eax,%ebx
80104198:	81 c2 84 00 00 00    	add    $0x84,%edx
8010419e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801041a4:	72 ea                	jb     80104190 <get_max_pid+0x20>
		if(p -> pid > max_pid)
			max_pid = p -> pid;
	}
	release(&ptable.lock);
...
801041ae:	e8 dd 03 00 00       	call   80104590 <release>
...
801041d3:	e8 f8 02 00 00       	call   801044d0 <acquire>
801041d8:	83 c4 10             	add    $0x10,%esp
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041db:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801041e0:	eb 12                	jmp    801041f4 <get_proc_info+0x34>
801041e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801041e8:	05 84 00 00 00       	add    $0x84,%eax
801041ed:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801041f2:	73 4c                	jae    80104240 <get_proc_info+0x80>
		if(p->pid == pid){
801041f4:	39 58 10             	cmp    %ebx,0x10(%eax)
801041f7:	75 ef                	jne    801041e8 <get_proc_info+0x28>

			//pid가 1일때 부모는 0으로 설정해준다
			if(pid == 1)
801041f9:	83 fb 01             	cmp    $0x1,%ebx
801041fc:	74 32                	je     80104230 <get_proc_info+0x70>
				procInfo -> ppid = 0;
			else
				procInfo -> ppid = p->parent->pid;
801041fe:	8b 50 14             	mov    0x14(%eax),%edx
80104201:	8b 52 10             	mov    0x10(%edx),%edx
80104204:	89 16                	mov    %edx,(%esi)
			procInfo -> psize = p-> sz;
80104206:	8b 10                	mov    (%eax),%edx
			procInfo -> numberContextSwitches= p->ctsw_cnt;
			
			release(&ptable.lock);
80104208:	83 ec 0c             	sub    $0xc,%esp
			procInfo -> psize = p-> sz;
8010420b:	89 56 04             	mov    %edx,0x4(%esi)
			procInfo -> numberContextSwitches= p->ctsw_cnt;
8010420e:	8b 40 7c             	mov    0x7c(%eax),%eax
80104211:	89 46 08             	mov    %eax,0x8(%esi)
			release(&ptable.lock);
80104214:	68 20 2d 11 80       	push   $0x80112d20
80104219:	e8 72 03 00 00       	call   80104590 <release>
			return 0;
...
8010422a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
				procInfo -> ppid = 0;
80104230:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80104236:	eb ce                	jmp    80104206 <get_proc_info+0x46>
80104238:	90                   	nop
80104239:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	release(&ptable.lock);
80104240:	83 ec 0c             	sub    $0xc,%esp
80104243:	68 20 2d 11 80       	push   $0x80112d20
80104248:	e8 43 03 00 00       	call   80104590 <release>
	return -1;
8010424d:	83 c4 10             	add    $0x10,%esp
}
80104250:	8d 65 f8             	lea    -0x8(%ebp),%esp
	return -1;
...
8010426a:	68 f8 77 10 80       	push   $0x801077f8
...
801042c5:	e8 e6 fa ff ff       	call   80103db0 <sleep>
  while (lk->locked) {
...
801042d3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042d9:	e8 32 f5 ff ff       	call   80103810 <myproc>
...
80104324:	e8 47 fc ff ff       	call   80103f70 <wakeup>
  release(&lk->lk);
...
80104363:	e8 a8 f4 ff ff       	call   80103810 <myproc>
...
80104409:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010440a:	e8 61 f3 ff ff       	call   80103770 <mycpu>
...
8010441f:	e8 4c f3 ff ff       	call   80103770 <mycpu>
80104424:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010442a:	e8 41 f3 ff ff       	call   80103770 <mycpu>
...
8010444b:	75 35                	jne    80104482 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010444d:	e8 1e f3 ff ff       	call   80103770 <mycpu>
...
8010446c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104470:	e8 fb f2 ff ff       	call   80103770 <mycpu>
...
80104485:	68 03 78 10 80       	push   $0x80107803
8010448a:	e8 01 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010448f:	83 ec 0c             	sub    $0xc,%esp
80104492:	68 1a 78 10 80       	push   $0x8010781a
...
801044b8:	e8 b3 f2 ff ff       	call   80103770 <mycpu>
...
80104514:	e8 57 f2 ff ff       	call   80103770 <mycpu>
...
80104577:	68 21 78 10 80       	push   $0x80107821
...
801045cc:	68 29 78 10 80       	push   $0x80107829
...
80104837:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010483a:	e8 d1 ef ff ff       	call   80103810 <myproc>
...
80104877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010487a:	e8 91 ef ff ff       	call   80103810 <myproc>
...
801048e5:	e8 26 ef ff ff       	call   80103810 <myproc>
...
801048f3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801048f6:	e8 15 ef ff ff       	call   80103810 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104938:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010493b:	e8 d0 ee ff ff       	call   80103810 <myproc>
...
801049d4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801049d7:	e8 34 ee ff ff       	call   80103810 <myproc>
...
801049e7:	83 fa 1b             	cmp    $0x1b,%edx
801049ea:	77 1c                	ja     80104a08 <syscall+0x38>
801049ec:	8b 14 85 60 78 10 80 	mov    -0x7fef87a0(,%eax,4),%edx
...
80104b64:	68 f0 78 10 80       	push   $0x801078f0
...
80104b7c:	68 ef 78 10 80       	push   $0x801078ef
...
80104b95:	68 e3 78 10 80       	push   $0x801078e3
...
80104baa:	68 f2 78 10 80       	push   $0x801078f2
80104baf:	e8 dc b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104bb4:	83 ec 0c             	sub    $0xc,%esp
80104bb7:	68 d4 78 10 80       	push   $0x801078d4
...
80104bf4:	e8 17 ec ff ff       	call   80103810 <myproc>
...
80104c39:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c3b:	e8 d0 eb ff ff       	call   80103810 <myproc>
...
80104d83:	78 2b                	js     80104db0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d85:	e8 86 ea ff ff       	call   80103810 <myproc>
...
80104fa9:	58                   	pop    %eax
80104faa:	5a                   	pop    %edx
80104fab:	68 f0 78 10 80       	push   $0x801078f0
...
80104fc4:	68 ef 78 10 80       	push   $0x801078ef
...
801051bf:	0f 84 a6 00 00 00    	je     8010526b <sys_open+0x12b>
  struct proc *curproc = myproc();
801051c5:	e8 46 e6 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105395:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105398:	e8 73 e4 ff ff       	call   80103810 <myproc>
...
8010556f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105571:	e8 9a e2 ff ff       	call   80103810 <myproc>
...
80105597:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010559a:	e8 71 e2 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801055d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801055d8:	e8 33 e2 ff ff       	call   80103810 <myproc>
...
80105613:	5d                   	pop    %ebp
  return fork();
80105614:	e9 97 e3 ff ff       	jmp    801039b0 <fork>
...
80105623:	83 ec 08             	sub    $0x8,%esp
  exit();
80105626:	e8 05 e6 ff ff       	call   80103c30 <exit>
...
80105633:	5d                   	pop    %ebp
  return wait();
80105634:	e9 37 e8 ff ff       	jmp    80103e70 <wait>
...
8010564c:	e8 8f f2 ff ff       	call   801048e0 <argint>
...
8010565e:	e8 6d e9 ff ff       	call   80103fd0 <kill>
...
80105683:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105686:	e8 85 e1 ff ff       	call   80103810 <myproc>
...
801056b6:	e8 75 e2 ff ff       	call   80103930 <growproc>
...
801056ed:	e8 ee f1 ff ff       	call   801048e0 <argint>
...
80105700:	68 60 4e 11 80       	push   $0x80114e60
80105705:	e8 c6 ed ff ff       	call   801044d0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010570a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010570d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105710:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
80105723:	68 60 4e 11 80       	push   $0x80114e60
80105728:	68 a0 56 11 80       	push   $0x801156a0
8010572d:	e8 7e e6 ff ff       	call   80103db0 <sleep>
  while(ticks - ticks0 < n){
80105732:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
8010573f:	73 2f                	jae    80105770 <sys_sleep+0x90>
    if(myproc()->killed){
80105741:	e8 ca e0 ff ff       	call   80103810 <myproc>
...
80105750:	68 60 4e 11 80       	push   $0x80114e60
80105755:	e8 36 ee ff ff       	call   80104590 <release>
      return -1;
...
80105773:	68 60 4e 11 80       	push   $0x80114e60
...
80105794:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105797:	68 60 4e 11 80       	push   $0x80114e60
8010579c:	e8 2f ed ff ff       	call   801044d0 <acquire>
  xticks = ticks;
801057a1:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
801057a7:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801057ae:	e8 dd ed ff ff       	call   80104590 <release>
  return xticks;
}
...
801057c3:	83 ec 14             	sub    $0x14,%esp
	...
	cprintf("helloxv6\n");
801057c6:	68 35 79 10 80       	push   $0x80107935
801057cb:	e8 90 ae ff ff       	call   80100660 <cprintf>
	return 0;
}
...
801057ec:	e8 9f f1 ff ff       	call   80104990 <argstr>
801057f1:	83 c4 10             	add    $0x10,%esp
801057f4:	85 c0                	test   %eax,%eax
801057f6:	78 18                	js     80105810 <sys_hello_name+0x30>
		return -1;
	cprintf("hello %s\n", name);
801057f8:	83 ec 08             	sub    $0x8,%esp
801057fb:	ff 75 f4             	pushl  -0xc(%ebp)
801057fe:	68 3f 79 10 80       	push   $0x8010793f
80105803:	e8 58 ae ff ff       	call   80100660 <cprintf>
...
80105823:	5d                   	pop    %ebp
	return get_num_proc();
80105824:	e9 f7 e8 ff ff       	jmp    80104120 <get_num_proc>
80105829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105830 <sys_get_max_pid>:
int
...
80105833:	5d                   	pop    %ebp
	return get_max_pid();
80105834:	e9 37 e9 ff ff       	jmp    80104170 <get_max_pid>
80105839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105840 <sys_get_proc_info>:
int
...
80105856:	78 30                	js     80105888 <sys_get_proc_info+0x48>
80105858:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010585b:	83 ec 04             	sub    $0x4,%esp
8010585e:	6a 0c                	push   $0xc
80105860:	50                   	push   %eax
80105861:	6a 01                	push   $0x1
80105863:	e8 c8 f0 ff ff       	call   80104930 <argptr>
80105868:	83 c4 10             	add    $0x10,%esp
8010586b:	85 c0                	test   %eax,%eax
8010586d:	75 19                	jne    80105888 <sys_get_proc_info+0x48>
		return -1;

	return get_proc_info(pid, procInfo);
8010586f:	83 ec 08             	sub    $0x8,%esp
80105872:	ff 75 f4             	pushl  -0xc(%ebp)
80105875:	ff 75 f0             	pushl  -0x10(%ebp)
80105878:	e8 43 e9 ff ff       	call   801041c0 <get_proc_info>
...
801058d6:	e8 35 df ff ff       	call   80103810 <myproc>
...
80105927:	c7 04 c5 a2 4e 11 80 	movl   $0x8e000008,-0x7feeb15e(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
80105954:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105957:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 49 79 10 80       	push   $0x80107949
80105966:	68 60 4e 11 80       	push   $0x80114e60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
8010597a:	e8 11 ea ff ff       	call   80104390 <initlock>
}
...
8010599b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010599f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
801059e0:	ff 24 85 f0 79 10 80 	jmp    *-0x7fef8610(,%eax,4)
...
801059f0:	e8 1b de ff ff       	call   80103810 <myproc>
...
80105a10:	e8 db dd ff ff       	call   801037f0 <cpuid>
...
80105a29:	e8 e2 dd ff ff       	call   80103810 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105a45:	68 ac 79 10 80       	push   $0x801079ac
...
80105a5e:	e8 ad dd ff ff       	call   80103810 <myproc>
80105a63:	85 c0                	test   %eax,%eax
80105a65:	74 1d                	je     80105a84 <trap+0xc4>
80105a67:	e8 a4 dd ff ff       	call   80103810 <myproc>
...
80105a84:	e8 87 dd ff ff       	call   80103810 <myproc>
80105a89:	85 c0                	test   %eax,%eax
80105a8b:	74 0b                	je     80105a98 <trap+0xd8>
80105a8d:	e8 7e dd ff ff       	call   80103810 <myproc>
...
80105a96:	74 68                	je     80105b00 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a98:	e8 73 dd ff ff       	call   80103810 <myproc>
80105a9d:	85 c0                	test   %eax,%eax
80105a9f:	74 19                	je     80105aba <trap+0xfa>
80105aa1:	e8 6a dd ff ff       	call   80103810 <myproc>
...
80105ac2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105ac8:	e8 43 dd ff ff       	call   80103810 <myproc>
...
80105add:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105ae0:	e8 eb ee ff ff       	call   801049d0 <syscall>
    if(myproc()->killed)
80105ae5:	e8 26 dd ff ff       	call   80103810 <myproc>
...
80105af7:	5d                   	pop    %ebp
      exit();
80105af8:	e9 33 e1 ff ff       	jmp    80103c30 <exit>
...
80105b1d:	e8 3e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b22:	e8 e9 dc ff ff       	call   80103810 <myproc>
...
80105b3d:	e8 1e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b42:	e8 c9 dc ff ff       	call   80103810 <myproc>
...
80105b5d:	e8 fe cb ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b62:	e8 a9 dc ff ff       	call   80103810 <myproc>
...
80105b7f:	e8 6c dc ff ff       	call   801037f0 <cpuid>
80105b84:	56                   	push   %esi
80105b85:	53                   	push   %ebx
80105b86:	50                   	push   %eax
80105b87:	68 54 79 10 80       	push   $0x80107954
...
80105b96:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b99:	e8 72 dc ff ff       	call   80103810 <myproc>
...
80105bba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bc0:	e8 6b e0 ff ff       	call   80103c30 <exit>
80105bc5:	e9 0e ff ff ff       	jmp    80105ad8 <trap+0x118>
80105bca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105bd0:	e8 5b e0 ff ff       	call   80103c30 <exit>
80105bd5:	e9 aa fe ff ff       	jmp    80105a84 <trap+0xc4>
80105bda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105be0:	83 ec 0c             	sub    $0xc,%esp
80105be3:	68 60 4e 11 80       	push   $0x80114e60
80105be8:	e8 e3 e8 ff ff       	call   801044d0 <acquire>
      wakeup(&ticks);
80105bed:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105bf4:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105bfb:	e8 70 e3 ff ff       	call   80103f70 <wakeup>
      release(&tickslock);
80105c00:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105c07:	e8 84 e9 ff ff       	call   80104590 <release>
80105c0c:	83 c4 10             	add    $0x10,%esp
80105c0f:	e9 09 ff ff ff       	jmp    80105b1d <trap+0x15d>
80105c14:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c17:	e8 d4 db ff ff       	call   801037f0 <cpuid>
...
80105c25:	68 78 79 10 80       	push   $0x80107978
80105c2a:	e8 31 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c2f:	83 c4 14             	add    $0x14,%esp
80105c32:	68 4e 79 10 80       	push   $0x8010794e
...
80105d2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d2f:	bb 70 7a 10 80       	mov    $0x80107a70,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105dc7:	6a 00                	push   $0x0
  jmp alltraps
80105dc9:	e9 15 fb ff ff       	jmp    801058e3 <alltraps>
...
80105dd0:	6a 01                	push   $0x1
  jmp alltraps
80105dd2:	e9 0c fb ff ff       	jmp    801058e3 <alltraps>
...
80105dd9:	6a 02                	push   $0x2
  jmp alltraps
80105ddb:	e9 03 fb ff ff       	jmp    801058e3 <alltraps>
...
80105de2:	6a 03                	push   $0x3
  jmp alltraps
80105de4:	e9 fa fa ff ff       	jmp    801058e3 <alltraps>
...
80105deb:	6a 04                	push   $0x4
  jmp alltraps
80105ded:	e9 f1 fa ff ff       	jmp    801058e3 <alltraps>
...
80105df4:	6a 05                	push   $0x5
  jmp alltraps
80105df6:	e9 e8 fa ff ff       	jmp    801058e3 <alltraps>
...
80105dfd:	6a 06                	push   $0x6
  jmp alltraps
80105dff:	e9 df fa ff ff       	jmp    801058e3 <alltraps>
...
80105e06:	6a 07                	push   $0x7
  jmp alltraps
80105e08:	e9 d6 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e24:	6a 0b                	push   $0xb
  jmp alltraps
80105e26:	e9 b8 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e2b:	6a 0c                	push   $0xc
  jmp alltraps
80105e2d:	e9 b1 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e32:	6a 0d                	push   $0xd
  jmp alltraps
80105e34:	e9 aa fa ff ff       	jmp    801058e3 <alltraps>
...
80105e39:	6a 0e                	push   $0xe
  jmp alltraps
80105e3b:	e9 a3 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e4b:	6a 10                	push   $0x10
  jmp alltraps
80105e4d:	e9 91 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e64:	6a 13                	push   $0x13
  jmp alltraps
80105e66:	e9 78 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e6d:	6a 14                	push   $0x14
  jmp alltraps
80105e6f:	e9 6f fa ff ff       	jmp    801058e3 <alltraps>
...
80105e76:	6a 15                	push   $0x15
  jmp alltraps
80105e78:	e9 66 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e7f:	6a 16                	push   $0x16
  jmp alltraps
80105e81:	e9 5d fa ff ff       	jmp    801058e3 <alltraps>
...
80105e88:	6a 17                	push   $0x17
  jmp alltraps
80105e8a:	e9 54 fa ff ff       	jmp    801058e3 <alltraps>
...
80105e91:	6a 18                	push   $0x18
  jmp alltraps
80105e93:	e9 4b fa ff ff       	jmp    801058e3 <alltraps>
...
80105e9a:	6a 19                	push   $0x19
  jmp alltraps
80105e9c:	e9 42 fa ff ff       	jmp    801058e3 <alltraps>
...
80105ea3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ea5:	e9 39 fa ff ff       	jmp    801058e3 <alltraps>
...
80105eac:	6a 1b                	push   $0x1b
  jmp alltraps
80105eae:	e9 30 fa ff ff       	jmp    801058e3 <alltraps>
...
80105eb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105eb7:	e9 27 fa ff ff       	jmp    801058e3 <alltraps>
...
80105ebe:	6a 1d                	push   $0x1d
  jmp alltraps
80105ec0:	e9 1e fa ff ff       	jmp    801058e3 <alltraps>
...
80105ec7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ec9:	e9 15 fa ff ff       	jmp    801058e3 <alltraps>
...
80105ed0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ed2:	e9 0c fa ff ff       	jmp    801058e3 <alltraps>
...
80105ed9:	6a 20                	push   $0x20
  jmp alltraps
80105edb:	e9 03 fa ff ff       	jmp    801058e3 <alltraps>
...
80105ee2:	6a 21                	push   $0x21
  jmp alltraps
80105ee4:	e9 fa f9 ff ff       	jmp    801058e3 <alltraps>
...
80105eeb:	6a 22                	push   $0x22
  jmp alltraps
80105eed:	e9 f1 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105ef4:	6a 23                	push   $0x23
  jmp alltraps
80105ef6:	e9 e8 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105efd:	6a 24                	push   $0x24
  jmp alltraps
80105eff:	e9 df f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f06:	6a 25                	push   $0x25
  jmp alltraps
80105f08:	e9 d6 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f0f:	6a 26                	push   $0x26
  jmp alltraps
80105f11:	e9 cd f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f18:	6a 27                	push   $0x27
  jmp alltraps
80105f1a:	e9 c4 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f21:	6a 28                	push   $0x28
  jmp alltraps
80105f23:	e9 bb f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f2a:	6a 29                	push   $0x29
  jmp alltraps
80105f2c:	e9 b2 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f33:	6a 2a                	push   $0x2a
  jmp alltraps
80105f35:	e9 a9 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f3e:	e9 a0 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f45:	6a 2c                	push   $0x2c
  jmp alltraps
80105f47:	e9 97 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f50:	e9 8e f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f57:	6a 2e                	push   $0x2e
  jmp alltraps
80105f59:	e9 85 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f60:	6a 2f                	push   $0x2f
  jmp alltraps
80105f62:	e9 7c f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f69:	6a 30                	push   $0x30
  jmp alltraps
80105f6b:	e9 73 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f72:	6a 31                	push   $0x31
  jmp alltraps
80105f74:	e9 6a f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f7b:	6a 32                	push   $0x32
  jmp alltraps
80105f7d:	e9 61 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f84:	6a 33                	push   $0x33
  jmp alltraps
80105f86:	e9 58 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f8d:	6a 34                	push   $0x34
  jmp alltraps
80105f8f:	e9 4f f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f96:	6a 35                	push   $0x35
  jmp alltraps
80105f98:	e9 46 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105f9f:	6a 36                	push   $0x36
  jmp alltraps
80105fa1:	e9 3d f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fa8:	6a 37                	push   $0x37
  jmp alltraps
80105faa:	e9 34 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fb1:	6a 38                	push   $0x38
  jmp alltraps
80105fb3:	e9 2b f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fba:	6a 39                	push   $0x39
  jmp alltraps
80105fbc:	e9 22 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fc3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fc5:	e9 19 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fcc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fce:	e9 10 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fd5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fd7:	e9 07 f9 ff ff       	jmp    801058e3 <alltraps>
...
80105fde:	6a 3d                	push   $0x3d
  jmp alltraps
80105fe0:	e9 fe f8 ff ff       	jmp    801058e3 <alltraps>
...
80105fe7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fe9:	e9 f5 f8 ff ff       	jmp    801058e3 <alltraps>
...
80105ff0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ff2:	e9 ec f8 ff ff       	jmp    801058e3 <alltraps>
...
80105ff9:	6a 40                	push   $0x40
  jmp alltraps
80105ffb:	e9 e3 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106002:	6a 41                	push   $0x41
  jmp alltraps
80106004:	e9 da f8 ff ff       	jmp    801058e3 <alltraps>
...
8010600b:	6a 42                	push   $0x42
  jmp alltraps
8010600d:	e9 d1 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106014:	6a 43                	push   $0x43
  jmp alltraps
80106016:	e9 c8 f8 ff ff       	jmp    801058e3 <alltraps>
...
8010601d:	6a 44                	push   $0x44
  jmp alltraps
8010601f:	e9 bf f8 ff ff       	jmp    801058e3 <alltraps>
...
80106026:	6a 45                	push   $0x45
  jmp alltraps
80106028:	e9 b6 f8 ff ff       	jmp    801058e3 <alltraps>
...
8010602f:	6a 46                	push   $0x46
  jmp alltraps
80106031:	e9 ad f8 ff ff       	jmp    801058e3 <alltraps>
...
80106038:	6a 47                	push   $0x47
  jmp alltraps
8010603a:	e9 a4 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106041:	6a 48                	push   $0x48
  jmp alltraps
80106043:	e9 9b f8 ff ff       	jmp    801058e3 <alltraps>
...
8010604a:	6a 49                	push   $0x49
  jmp alltraps
8010604c:	e9 92 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106053:	6a 4a                	push   $0x4a
  jmp alltraps
80106055:	e9 89 f8 ff ff       	jmp    801058e3 <alltraps>
...
8010605c:	6a 4b                	push   $0x4b
  jmp alltraps
8010605e:	e9 80 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106065:	6a 4c                	push   $0x4c
  jmp alltraps
80106067:	e9 77 f8 ff ff       	jmp    801058e3 <alltraps>
...
8010606e:	6a 4d                	push   $0x4d
  jmp alltraps
80106070:	e9 6e f8 ff ff       	jmp    801058e3 <alltraps>
...
80106077:	6a 4e                	push   $0x4e
  jmp alltraps
80106079:	e9 65 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106080:	6a 4f                	push   $0x4f
  jmp alltraps
80106082:	e9 5c f8 ff ff       	jmp    801058e3 <alltraps>
...
80106089:	6a 50                	push   $0x50
  jmp alltraps
8010608b:	e9 53 f8 ff ff       	jmp    801058e3 <alltraps>
...
80106092:	6a 51                	push   $0x51
  jmp alltraps
80106094:	e9 4a f8 ff ff       	jmp    801058e3 <alltraps>
...
8010609b:	6a 52                	push   $0x52
  jmp alltraps
8010609d:	e9 41 f8 ff ff       	jmp    801058e3 <alltraps>
...
801060a4:	6a 53                	push   $0x53
  jmp alltraps
801060a6:	e9 38 f8 ff ff       	jmp    801058e3 <alltraps>
...
801060ad:	6a 54                	push   $0x54
  jmp alltraps
801060af:	e9 2f f8 ff ff       	jmp    801058e3 <alltraps>
...
801060b6:	6a 55                	push   $0x55
  jmp alltraps
801060b8:	e9 26 f8 ff ff       	jmp    801058e3 <alltraps>
...
801060bf:	6a 56                	push   $0x56
  jmp alltraps
801060c1:	e9 1d f8 ff ff       	jmp    801058e3 <alltraps>
...
801060c8:	6a 57                	push   $0x57
  jmp alltraps
801060ca:	e9 14 f8 ff ff       	jmp    801058e3 <alltraps>
...
801060d1:	6a 58                	push   $0x58
  jmp alltraps
801060d3:	e9 0b f8 ff ff       	jmp    801058e3 <alltraps>
...
801060da:	6a 59                	push   $0x59
  jmp alltraps
801060dc:	e9 02 f8 ff ff       	jmp    801058e3 <alltraps>
...
801060e3:	6a 5a                	push   $0x5a
  jmp alltraps
801060e5:	e9 f9 f7 ff ff       	jmp    801058e3 <alltraps>
...
801060ec:	6a 5b                	push   $0x5b
  jmp alltraps
801060ee:	e9 f0 f7 ff ff       	jmp    801058e3 <alltraps>
...
801060f5:	6a 5c                	push   $0x5c
  jmp alltraps
801060f7:	e9 e7 f7 ff ff       	jmp    801058e3 <alltraps>
...
801060fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106100:	e9 de f7 ff ff       	jmp    801058e3 <alltraps>
...
80106107:	6a 5e                	push   $0x5e
  jmp alltraps
80106109:	e9 d5 f7 ff ff       	jmp    801058e3 <alltraps>
...
80106110:	6a 5f                	push   $0x5f
  jmp alltraps
80106112:	e9 cc f7 ff ff       	jmp    801058e3 <alltraps>
...
80106119:	6a 60                	push   $0x60
  jmp alltraps
8010611b:	e9 c3 f7 ff ff       	jmp    801058e3 <alltraps>
...
80106122:	6a 61                	push   $0x61
  jmp alltraps
80106124:	e9 ba f7 ff ff       	jmp    801058e3 <alltraps>
...
8010612b:	6a 62                	push   $0x62
  jmp alltraps
8010612d:	e9 b1 f7 ff ff       	jmp    801058e3 <alltraps>
...
80106134:	6a 63                	push   $0x63
  jmp alltraps
80106136:	e9 a8 f7 ff ff       	jmp    801058e3 <alltraps>
...
8010613d:	6a 64                	push   $0x64
  jmp alltraps
8010613f:	e9 9f f7 ff ff       	jmp    801058e3 <alltraps>
...
80106146:	6a 65                	push   $0x65
  jmp alltraps
80106148:	e9 96 f7 ff ff       	jmp    801058e3 <alltraps>
...
8010614f:	6a 66                	push   $0x66
  jmp alltraps
80106151:	e9 8d f7 ff ff       	jmp    801058e3 <alltraps>
...
80106158:	6a 67                	push   $0x67
  jmp alltraps
8010615a:	e9 84 f7 ff ff       	jmp    801058e3 <alltraps>
...
80106161:	6a 68                	push   $0x68
  jmp alltraps
80106163:	e9 7b f7 ff ff       	jmp    801058e3 <alltraps>
...
8010616a:	6a 69                	push   $0x69
  jmp alltraps
8010616c:	e9 72 f7 ff ff       	jmp    801058e3 <alltraps>
...
80106173:	6a 6a                	push   $0x6a
  jmp alltraps
80106175:	e9 69 f7 ff ff       	jmp    801058e3 <alltraps>
...
8010617c:	6a 6b                	push   $0x6b
  jmp alltraps
8010617e:	e9 60 f7 ff ff       	jmp    801058e3 <alltraps>
...
80106185:	6a 6c                	push   $0x6c
  jmp alltraps
80106187:	e9 57 f7 ff ff       	jmp    801058e3 <alltraps>
...
8010618e:	6a 6d                	push   $0x6d
  jmp alltraps
80106190:	e9 4e f7 ff ff       	jmp    801058e3 <alltraps>
...
80106197:	6a 6e                	push   $0x6e
  jmp alltraps
80106199:	e9 45 f7 ff ff       	jmp    801058e3 <alltraps>
...
801061a0:	6a 6f                	push   $0x6f
  jmp alltraps
801061a2:	e9 3c f7 ff ff       	jmp    801058e3 <alltraps>
...
801061a9:	6a 70                	push   $0x70
  jmp alltraps
801061ab:	e9 33 f7 ff ff       	jmp    801058e3 <alltraps>
...
801061b2:	6a 71                	push   $0x71
  jmp alltraps
801061b4:	e9 2a f7 ff ff       	jmp    801058e3 <alltraps>
...
801061bb:	6a 72                	push   $0x72
  jmp alltraps
801061bd:	e9 21 f7 ff ff       	jmp    801058e3 <alltraps>
...
801061c4:	6a 73                	push   $0x73
  jmp alltraps
801061c6:	e9 18 f7 ff ff       	jmp    801058e3 <alltraps>
...
801061cd:	6a 74                	push   $0x74
  jmp alltraps
801061cf:	e9 0f f7 ff ff       	jmp    801058e3 <alltraps>
...
801061d6:	6a 75                	push   $0x75
  jmp alltraps
801061d8:	e9 06 f7 ff ff       	jmp    801058e3 <alltraps>
...
801061df:	6a 76                	push   $0x76
  jmp alltraps
801061e1:	e9 fd f6 ff ff       	jmp    801058e3 <alltraps>
...
801061e8:	6a 77                	push   $0x77
  jmp alltraps
801061ea:	e9 f4 f6 ff ff       	jmp    801058e3 <alltraps>
...
801061f1:	6a 78                	push   $0x78
  jmp alltraps
801061f3:	e9 eb f6 ff ff       	jmp    801058e3 <alltraps>
...
801061fa:	6a 79                	push   $0x79
  jmp alltraps
801061fc:	e9 e2 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106203:	6a 7a                	push   $0x7a
  jmp alltraps
80106205:	e9 d9 f6 ff ff       	jmp    801058e3 <alltraps>
...
8010620c:	6a 7b                	push   $0x7b
  jmp alltraps
8010620e:	e9 d0 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106215:	6a 7c                	push   $0x7c
  jmp alltraps
80106217:	e9 c7 f6 ff ff       	jmp    801058e3 <alltraps>
...
8010621e:	6a 7d                	push   $0x7d
  jmp alltraps
80106220:	e9 be f6 ff ff       	jmp    801058e3 <alltraps>
...
80106227:	6a 7e                	push   $0x7e
  jmp alltraps
80106229:	e9 b5 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106230:	6a 7f                	push   $0x7f
  jmp alltraps
80106232:	e9 ac f6 ff ff       	jmp    801058e3 <alltraps>
...
80106239:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010623e:	e9 a0 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106245:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010624a:	e9 94 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106251:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106256:	e9 88 f6 ff ff       	jmp    801058e3 <alltraps>
...
8010625d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106262:	e9 7c f6 ff ff       	jmp    801058e3 <alltraps>
...
80106269:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010626e:	e9 70 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106275:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010627a:	e9 64 f6 ff ff       	jmp    801058e3 <alltraps>
...
80106281:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106286:	e9 58 f6 ff ff       	jmp    801058e3 <alltraps>
...
8010628d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106292:	e9 4c f6 ff ff       	jmp    801058e3 <alltraps>
...
80106299:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010629e:	e9 40 f6 ff ff       	jmp    801058e3 <alltraps>
...
801062a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062aa:	e9 34 f6 ff ff       	jmp    801058e3 <alltraps>
...
801062b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062b6:	e9 28 f6 ff ff       	jmp    801058e3 <alltraps>
...
801062bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062c2:	e9 1c f6 ff ff       	jmp    801058e3 <alltraps>
...
801062c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062ce:	e9 10 f6 ff ff       	jmp    801058e3 <alltraps>
...
801062d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062da:	e9 04 f6 ff ff       	jmp    801058e3 <alltraps>
...
801062e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062e6:	e9 f8 f5 ff ff       	jmp    801058e3 <alltraps>
...
801062ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062f2:	e9 ec f5 ff ff       	jmp    801058e3 <alltraps>
...
801062f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062fe:	e9 e0 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106305:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010630a:	e9 d4 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106311:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106316:	e9 c8 f5 ff ff       	jmp    801058e3 <alltraps>
...
8010631d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106322:	e9 bc f5 ff ff       	jmp    801058e3 <alltraps>
...
80106329:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010632e:	e9 b0 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106335:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010633a:	e9 a4 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106341:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106346:	e9 98 f5 ff ff       	jmp    801058e3 <alltraps>
...
8010634d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106352:	e9 8c f5 ff ff       	jmp    801058e3 <alltraps>
...
80106359:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010635e:	e9 80 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106365:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010636a:	e9 74 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106371:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106376:	e9 68 f5 ff ff       	jmp    801058e3 <alltraps>
...
8010637d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106382:	e9 5c f5 ff ff       	jmp    801058e3 <alltraps>
...
80106389:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010638e:	e9 50 f5 ff ff       	jmp    801058e3 <alltraps>
...
80106395:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010639a:	e9 44 f5 ff ff       	jmp    801058e3 <alltraps>
...
801063a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063a6:	e9 38 f5 ff ff       	jmp    801058e3 <alltraps>
...
801063ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063b2:	e9 2c f5 ff ff       	jmp    801058e3 <alltraps>
...
801063b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063be:	e9 20 f5 ff ff       	jmp    801058e3 <alltraps>
...
801063c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063ca:	e9 14 f5 ff ff       	jmp    801058e3 <alltraps>
...
801063d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063d6:	e9 08 f5 ff ff       	jmp    801058e3 <alltraps>
...
801063dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063e2:	e9 fc f4 ff ff       	jmp    801058e3 <alltraps>
...
801063e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063ee:	e9 f0 f4 ff ff       	jmp    801058e3 <alltraps>
...
801063f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063fa:	e9 e4 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106401:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106406:	e9 d8 f4 ff ff       	jmp    801058e3 <alltraps>
...
8010640d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106412:	e9 cc f4 ff ff       	jmp    801058e3 <alltraps>
...
80106419:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010641e:	e9 c0 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106425:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010642a:	e9 b4 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106431:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106436:	e9 a8 f4 ff ff       	jmp    801058e3 <alltraps>
...
8010643d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106442:	e9 9c f4 ff ff       	jmp    801058e3 <alltraps>
...
80106449:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010644e:	e9 90 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106455:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010645a:	e9 84 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106461:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106466:	e9 78 f4 ff ff       	jmp    801058e3 <alltraps>
...
8010646d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106472:	e9 6c f4 ff ff       	jmp    801058e3 <alltraps>
...
80106479:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010647e:	e9 60 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106485:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010648a:	e9 54 f4 ff ff       	jmp    801058e3 <alltraps>
...
80106491:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106496:	e9 48 f4 ff ff       	jmp    801058e3 <alltraps>
...
8010649d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064a2:	e9 3c f4 ff ff       	jmp    801058e3 <alltraps>
...
801064a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064ae:	e9 30 f4 ff ff       	jmp    801058e3 <alltraps>
...
801064b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ba:	e9 24 f4 ff ff       	jmp    801058e3 <alltraps>
...
801064c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064c6:	e9 18 f4 ff ff       	jmp    801058e3 <alltraps>
...
801064cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064d2:	e9 0c f4 ff ff       	jmp    801058e3 <alltraps>
...
801064d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064de:	e9 00 f4 ff ff       	jmp    801058e3 <alltraps>
...
801064e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ea:	e9 f4 f3 ff ff       	jmp    801058e3 <alltraps>
...
801064f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064f6:	e9 e8 f3 ff ff       	jmp    801058e3 <alltraps>
...
801064fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106502:	e9 dc f3 ff ff       	jmp    801058e3 <alltraps>
...
80106509:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010650e:	e9 d0 f3 ff ff       	jmp    801058e3 <alltraps>
...
80106515:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010651a:	e9 c4 f3 ff ff       	jmp    801058e3 <alltraps>
...
80106521:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106526:	e9 b8 f3 ff ff       	jmp    801058e3 <alltraps>
...
8010652d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106532:	e9 ac f3 ff ff       	jmp    801058e3 <alltraps>
...
80106539:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010653e:	e9 a0 f3 ff ff       	jmp    801058e3 <alltraps>
...
80106545:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010654a:	e9 94 f3 ff ff       	jmp    801058e3 <alltraps>
...
80106551:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106556:	e9 88 f3 ff ff       	jmp    801058e3 <alltraps>
...
8010655d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106562:	e9 7c f3 ff ff       	jmp    801058e3 <alltraps>
...
80106569:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010656e:	e9 70 f3 ff ff       	jmp    801058e3 <alltraps>
...
80106575:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010657a:	e9 64 f3 ff ff       	jmp    801058e3 <alltraps>
...
80106581:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106586:	e9 58 f3 ff ff       	jmp    801058e3 <alltraps>
...
8010658d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106592:	e9 4c f3 ff ff       	jmp    801058e3 <alltraps>
...
80106599:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010659e:	e9 40 f3 ff ff       	jmp    801058e3 <alltraps>
...
801065a5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065aa:	e9 34 f3 ff ff       	jmp    801058e3 <alltraps>
...
801065b1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065b6:	e9 28 f3 ff ff       	jmp    801058e3 <alltraps>
...
801065bd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065c2:	e9 1c f3 ff ff       	jmp    801058e3 <alltraps>
...
801065c9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065ce:	e9 10 f3 ff ff       	jmp    801058e3 <alltraps>
...
801065d5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065da:	e9 04 f3 ff ff       	jmp    801058e3 <alltraps>
...
801065e1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065e6:	e9 f8 f2 ff ff       	jmp    801058e3 <alltraps>
...
801065ed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065f2:	e9 ec f2 ff ff       	jmp    801058e3 <alltraps>
...
801065f9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065fe:	e9 e0 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106605:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010660a:	e9 d4 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106611:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106616:	e9 c8 f2 ff ff       	jmp    801058e3 <alltraps>
...
8010661d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106622:	e9 bc f2 ff ff       	jmp    801058e3 <alltraps>
...
80106629:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010662e:	e9 b0 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106635:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010663a:	e9 a4 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106641:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106646:	e9 98 f2 ff ff       	jmp    801058e3 <alltraps>
...
8010664d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106652:	e9 8c f2 ff ff       	jmp    801058e3 <alltraps>
...
80106659:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010665e:	e9 80 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106665:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010666a:	e9 74 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106671:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106676:	e9 68 f2 ff ff       	jmp    801058e3 <alltraps>
...
8010667d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106682:	e9 5c f2 ff ff       	jmp    801058e3 <alltraps>
...
80106689:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010668e:	e9 50 f2 ff ff       	jmp    801058e3 <alltraps>
...
80106695:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010669a:	e9 44 f2 ff ff       	jmp    801058e3 <alltraps>
...
801066a1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066a6:	e9 38 f2 ff ff       	jmp    801058e3 <alltraps>
...
801066ad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066b2:	e9 2c f2 ff ff       	jmp    801058e3 <alltraps>
...
801066b9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066be:	e9 20 f2 ff ff       	jmp    801058e3 <alltraps>
...
801066c5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066ca:	e9 14 f2 ff ff       	jmp    801058e3 <alltraps>
...
801066d1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066d6:	e9 08 f2 ff ff       	jmp    801058e3 <alltraps>
...
801066dd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066e2:	e9 fc f1 ff ff       	jmp    801058e3 <alltraps>
...
801066e9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066ee:	e9 f0 f1 ff ff       	jmp    801058e3 <alltraps>
...
801066f5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066fa:	e9 e4 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106701:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106706:	e9 d8 f1 ff ff       	jmp    801058e3 <alltraps>
...
8010670d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106712:	e9 cc f1 ff ff       	jmp    801058e3 <alltraps>
...
80106719:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010671e:	e9 c0 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106725:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010672a:	e9 b4 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106731:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106736:	e9 a8 f1 ff ff       	jmp    801058e3 <alltraps>
...
8010673d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106742:	e9 9c f1 ff ff       	jmp    801058e3 <alltraps>
...
80106749:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010674e:	e9 90 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106755:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010675a:	e9 84 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106761:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106766:	e9 78 f1 ff ff       	jmp    801058e3 <alltraps>
...
8010676d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106772:	e9 6c f1 ff ff       	jmp    801058e3 <alltraps>
...
80106779:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010677e:	e9 60 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106785:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010678a:	e9 54 f1 ff ff       	jmp    801058e3 <alltraps>
...
80106791:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106796:	e9 48 f1 ff ff       	jmp    801058e3 <alltraps>
...
8010679d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067a2:	e9 3c f1 ff ff       	jmp    801058e3 <alltraps>
...
801067a9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067ae:	e9 30 f1 ff ff       	jmp    801058e3 <alltraps>
...
801067b5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ba:	e9 24 f1 ff ff       	jmp    801058e3 <alltraps>
...
801067c1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067c6:	e9 18 f1 ff ff       	jmp    801058e3 <alltraps>
...
801067cd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067d2:	e9 0c f1 ff ff       	jmp    801058e3 <alltraps>
...
801067d9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067de:	e9 00 f1 ff ff       	jmp    801058e3 <alltraps>
...
801067e5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ea:	e9 f4 f0 ff ff       	jmp    801058e3 <alltraps>
...
801067f1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067f6:	e9 e8 f0 ff ff       	jmp    801058e3 <alltraps>
...
801067fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106802:	e9 dc f0 ff ff       	jmp    801058e3 <alltraps>
...
80106809:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010680e:	e9 d0 f0 ff ff       	jmp    801058e3 <alltraps>
...
80106815:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010681a:	e9 c4 f0 ff ff       	jmp    801058e3 <alltraps>
...
80106821:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106826:	e9 b8 f0 ff ff       	jmp    801058e3 <alltraps>
...
8010682d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106832:	e9 ac f0 ff ff       	jmp    801058e3 <alltraps>
...
8010689a:	e8 41 dd ff ff       	call   801045e0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010693d:	68 78 7a 10 80       	push   $0x80107a78
...
801069f3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069f6:	e8 f5 cd ff ff       	call   801037f0 <cpuid>
...
80106a80:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106ac4:	0f 84 c2 00 00 00    	je     80106b8c <switchuvm+0xec>
  pushcli();
80106aca:	e8 31 d9 ff ff       	call   80104400 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106acf:	e8 9c cc ff ff       	call   80103770 <mycpu>
80106ad4:	89 c6                	mov    %eax,%esi
80106ad6:	e8 95 cc ff ff       	call   80103770 <mycpu>
...
80106ae8:	e8 83 cc ff ff       	call   80103770 <mycpu>
...
80106bdf:	e8 fc d9 ff ff       	call   801045e0 <memset>
...
80106c10:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c11:	e9 7a da ff ff       	jmp    80104690 <memmove>
    panic("inituvm: more than a page");
80106c16:	83 ec 0c             	sub    $0xc,%esp
80106c19:	68 bd 7a 10 80       	push   $0x80107abd
...
80106d3b:	e8 a0 d8 ff ff       	call   801045e0 <memset>
...
80106d7d:	68 f5 7a 10 80       	push   $0x80107af5
...
80106db3:	68 0d 7b 10 80       	push   $0x80107b0d
...
80106ebc:	68 29 7b 10 80       	push   $0x80107b29
...
80106ef0:	e8 eb d6 ff ff       	call   801045e0 <memset>
...
80106f5b:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f8f:	68 3a 7b 10 80       	push   $0x80107b3a
...
80106fe0:	e8 ab d6 ff ff       	call   80104690 <memmove>
...
80107079:	68 5e 7b 10 80       	push   $0x80107b5e
8010707e:	e8 0d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107083:	83 ec 0c             	sub    $0xc,%esp
80107086:	68 44 7b 10 80       	push   $0x80107b44
...
8010710f:	e8 7c d5 ff ff       	call   80104690 <memmove>
    len -= n;
    buf += n;
