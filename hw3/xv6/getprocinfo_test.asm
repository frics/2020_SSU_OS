...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb e9 07 00 00       	mov    $0x7e9,%ebx
        while(*s != 0){
 ...
 611:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 9c 0a 00 00    	cmp    %eax,0xa9c
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 767:	0a 00 00 
 76a:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
 779:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 780:	00 00 00 
