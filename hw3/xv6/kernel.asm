...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 c7 7c 10 80 	movl   $0x80107cc7,(%esp)
...
80101ed8:	68 9a 7a 10 80       	push   $0x80107a9a
...
801035e7:	e8 a4 0a 00 00       	call   80104090 <wakeup>
  release(&p->lock);
...
80103674:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
	release(&ptable.lock);
8010367a:	e8 c1 10 00 00       	call   80104740 <release>
...
8010369c:	89 53 18             	mov    %edx,0x18(%ebx)
	*(uint*)sp = (uint)trapret;
8010369f:	c7 40 14 a1 5a 10 80 	movl   $0x80105aa1,0x14(%eax)
	p->context = (struct context*)sp;
...
801036ae:	e8 dd 10 00 00       	call   80104790 <memset>
...
801036da:	e8 61 10 00 00       	call   80104740 <release>
}
...
80103756:	68 75 78 10 80       	push   $0x80107875
...
80103853:	e8 18 38 00 00       	call   80107070 <setupkvm>
...
80103871:	e8 da 34 00 00       	call   80106d50 <inituvm>
...
801038df:	68 a5 78 10 80       	push   $0x801078a5
801038e4:	50                   	push   %eax
801038e5:	e8 86 10 00 00       	call   80104970 <safestrcpy>
	p->cwd = namei("/");
801038ea:	c7 04 24 ae 78 10 80 	movl   $0x801078ae,(%esp)
...
80103923:	68 8c 78 10 80       	push   $0x8010788c
...
8010395c:	e8 df 32 00 00       	call   80106c40 <switchuvm>
	return 0;
...
8010397a:	e8 11 35 00 00       	call   80106e90 <allocuvm>
...
8010399a:	e8 21 36 00 00       	call   80106fc0 <deallocuvm>
...
801039e8:	e8 53 37 00 00       	call   80107140 <copyuvm>
...
80103aff:	e8 7c 0b 00 00       	call   80104680 <acquire>
...
80103b42:	e8 f9 0b 00 00       	call   80104740 <release>
		acquire(&ptable.lock);
80103b47:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b4e:	e8 2d 0b 00 00       	call   80104680 <acquire>
		for(i=0; i<n-1; i++){
80103b53:	8d 47 ff             	lea    -0x1(%edi),%eax
80103b56:	83 c4 10             	add    $0x10,%esp
80103b59:	85 c0                	test   %eax,%eax
80103b5b:	7e 37                	jle    80103b94 <scheduler+0xc4>
80103b5d:	89 c6                	mov    %eax,%esi
80103b5f:	90                   	nop
			for(j=0; j<n-i-1; j++){
80103b60:	31 c0                	xor    %eax,%eax
80103b62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
				if(queue[j] < queue[j+1]){
80103b68:	8b 94 85 e8 fe ff ff 	mov    -0x118(%ebp,%eax,4),%edx
80103b6f:	83 c0 01             	add    $0x1,%eax
80103b72:	8b 8c 85 e8 fe ff ff 	mov    -0x118(%ebp,%eax,4),%ecx
80103b79:	39 ca                	cmp    %ecx,%edx
80103b7b:	7d 0e                	jge    80103b8b <scheduler+0xbb>
					queue[j] = queue[j+1];
80103b7d:	89 8c 85 e4 fe ff ff 	mov    %ecx,-0x11c(%ebp,%eax,4)
					queue[j+1] = tmp;
80103b84:	89 94 85 e8 fe ff ff 	mov    %edx,-0x118(%ebp,%eax,4)
			for(j=0; j<n-i-1; j++){
80103b8b:	39 f0                	cmp    %esi,%eax
80103b8d:	7c d9                	jl     80103b68 <scheduler+0x98>
		for(i=0; i<n-1; i++){
80103b8f:	83 ee 01             	sub    $0x1,%esi
80103b92:	75 cc                	jne    80103b60 <scheduler+0x90>
		release(&ptable.lock);
80103b94:	83 ec 0c             	sub    $0xc,%esp
80103b97:	68 20 2d 11 80       	push   $0x80112d20
80103b9c:	e8 9f 0b 00 00       	call   80104740 <release>
		for(i=0; i<n; i++){
80103ba1:	8b 8d dc fe ff ff    	mov    -0x124(%ebp),%ecx
80103ba7:	83 c4 10             	add    $0x10,%esp
80103baa:	85 c9                	test   %ecx,%ecx
80103bac:	0f 84 44 ff ff ff    	je     80103af6 <scheduler+0x26>
80103bb2:	8d bd e8 fe ff ff    	lea    -0x118(%ebp),%edi
80103bb8:	c7 85 e0 fe ff ff 00 	movl   $0x0,-0x120(%ebp)
80103bbf:	00 00 00 
80103bc2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
			acquire(&ptable.lock);
80103bc8:	83 ec 0c             	sub    $0xc,%esp
			for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bcb:	be 54 2d 11 80       	mov    $0x80112d54,%esi
			acquire(&ptable.lock);
80103bd0:	68 20 2d 11 80       	push   $0x80112d20
80103bd5:	e8 a6 0a 00 00       	call   80104680 <acquire>
80103bda:	83 c4 10             	add    $0x10,%esp
80103bdd:	eb 0f                	jmp    80103bee <scheduler+0x11e>
80103bdf:	90                   	nop
			for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103be0:	81 c6 84 00 00 00    	add    $0x84,%esi
80103be6:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
80103bec:	73 62                	jae    80103c50 <scheduler+0x180>
				if(p->state != RUNNABLE)
80103bee:	83 7e 0c 03          	cmpl   $0x3,0xc(%esi)
80103bf2:	75 ec                	jne    80103be0 <scheduler+0x110>
				if(p-> priority >= queue[i]){
80103bf4:	8b 07                	mov    (%edi),%eax
80103bf6:	39 86 80 00 00 00    	cmp    %eax,0x80(%esi)
80103bfc:	7c e2                	jl     80103be0 <scheduler+0x110>
					switchuvm(p);
80103bfe:	83 ec 0c             	sub    $0xc,%esp
					c->proc = p;
80103c01:	89 b3 ac 00 00 00    	mov    %esi,0xac(%ebx)
					switchuvm(p);
80103c07:	56                   	push   %esi
80103c08:	e8 33 30 00 00       	call   80106c40 <switchuvm>
					p->state = RUNNING;
80103c0d:	c7 46 0c 04 00 00 00 	movl   $0x4,0xc(%esi)
					swtch(&(c->scheduler), p->context);
80103c14:	58                   	pop    %eax
80103c15:	5a                   	pop    %edx
80103c16:	ff 76 1c             	pushl  0x1c(%esi)
80103c19:	ff b5 e4 fe ff ff    	pushl  -0x11c(%ebp)
80103c1f:	e8 a7 0d 00 00       	call   801049cb <swtch>
					switchkvm();
80103c24:	e8 f7 2f 00 00       	call   80106c20 <switchkvm>
					p->switch_cnt++;
80103c29:	83 46 7c 01          	addl   $0x1,0x7c(%esi)
			for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c2d:	81 c6 84 00 00 00    	add    $0x84,%esi
					c->proc = 0;
80103c33:	83 c4 10             	add    $0x10,%esp
			for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c36:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
					c->proc = 0;
80103c3c:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103c43:	00 00 00 
			for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c46:	72 a6                	jb     80103bee <scheduler+0x11e>
80103c48:	90                   	nop
80103c49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			release(&ptable.lock);
80103c50:	83 ec 0c             	sub    $0xc,%esp
80103c53:	83 c7 04             	add    $0x4,%edi
80103c56:	68 20 2d 11 80       	push   $0x80112d20
80103c5b:	e8 e0 0a 00 00       	call   80104740 <release>
		for(i=0; i<n; i++){
80103c60:	83 85 e0 fe ff ff 01 	addl   $0x1,-0x120(%ebp)
80103c67:	83 c4 10             	add    $0x10,%esp
80103c6a:	8b 85 e0 fe ff ff    	mov    -0x120(%ebp),%eax
80103c70:	39 85 dc fe ff ff    	cmp    %eax,-0x124(%ebp)
80103c76:	0f 85 4c ff ff ff    	jne    80103bc8 <scheduler+0xf8>
80103c7c:	e9 75 fe ff ff       	jmp    80103af6 <scheduler+0x26>
80103c81:	eb 0d                	jmp    80103c90 <sched>
80103c83:	90                   	nop
80103c84:	90                   	nop
80103c85:	90                   	nop
80103c86:	90                   	nop
...
80103c95:	e8 16 09 00 00       	call   801045b0 <pushcli>
	c = mycpu();
80103c9a:	e8 d1 fa ff ff       	call   80103770 <mycpu>
	p = c->proc;
...
80103cd7:	75 41                	jne    80103d1a <sched+0x8a>
	intena = mycpu()->intena;
80103cd9:	e8 92 fa ff ff       	call   80103770 <mycpu>
	swtch(&p->context, mycpu()->scheduler);
80103cde:	83 c3 1c             	add    $0x1c,%ebx
	intena = mycpu()->intena;
80103ce1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
	swtch(&p->context, mycpu()->scheduler);
80103ce7:	e8 84 fa ff ff       	call   80103770 <mycpu>
...
80103cf3:	e8 d3 0c 00 00       	call   801049cb <swtch>
	mycpu()->intena = intena;
80103cf8:	e8 73 fa ff ff       	call   80103770 <mycpu>
}
...
80103d59:	e8 52 08 00 00       	call   801045b0 <pushcli>
	c = mycpu();
80103d5e:	e8 0d fa ff ff       	call   80103770 <mycpu>
	p = c->proc;
...
80103ddd:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103def:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103df6:	05 84 00 00 00       	add    $0x84,%eax
80103dfb:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103e00:	72 e2                	jb     80103de4 <exit+0x94>
			p->parent = initproc;
80103e02:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e08:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103e0d:	eb 0f                	jmp    80103e1e <exit+0xce>
80103e0f:	90                   	nop
80103e10:	81 c2 84 00 00 00    	add    $0x84,%edx
80103e16:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
...
80103e3d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103e67:	68 fd 78 10 80       	push   $0x801078fd
80103e6c:	e8 1f c5 ff ff       	call   80100390 <panic>
		panic("init exiting");
80103e71:	83 ec 0c             	sub    $0xc,%esp
80103e74:	68 f0 78 10 80       	push   $0x801078f0
...
80103f79:	68 0f 79 10 80       	push   $0x8010790f
80103f7e:	e8 0d c4 ff ff       	call   80100390 <panic>
		panic("sleep");
80103f83:	83 ec 0c             	sub    $0xc,%esp
80103f86:	68 09 79 10 80       	push   $0x80107909
...
80103fce:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
80103fe7:	b8 01 00 00 00       	mov    $0x1,%eax
		for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fec:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
8010402a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
				freevm(p->pgdir);
80104031:	e8 ba 2f 00 00       	call   80106ff0 <freevm>
				release(&ptable.lock);
...
801040b5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
801040d3:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801040d8:	72 e2                	jb     801040bc <wakeup+0x2c>
	wakeup1(chan);
	release(&ptable.lock);
801040da:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
801041b1:	83 f8 05             	cmp    $0x5,%eax
			state = "???";
801041b4:	ba 20 79 10 80       	mov    $0x80107920,%edx
		if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041b9:	77 11                	ja     801041cc <procdump+0x5c>
801041bb:	8b 14 85 80 79 10 80 	mov    -0x7fef8680(,%eax,4),%edx
			state = "???";
801041c2:	b8 20 79 10 80       	mov    $0x80107920,%eax
...
801041d4:	68 24 79 10 80       	push   $0x80107924
...
80104219:	68 61 73 10 80       	push   $0x80107361
...
80104243:	53                   	push   %ebx
	int proc_cnt=0;
80104244:	31 db                	xor    %ebx,%ebx
{
80104246:	83 ec 10             	sub    $0x10,%esp
	struct proc *p;

	acquire(&ptable.lock);
80104249:	68 20 2d 11 80       	push   $0x80112d20
8010424e:	e8 2d 04 00 00       	call   80104680 <acquire>
80104253:	83 c4 10             	add    $0x10,%esp

	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104256:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
8010425b:	90                   	nop
8010425c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		if(p->state != UNUSED)
			proc_cnt++;
80104260:	83 7a 0c 01          	cmpl   $0x1,0xc(%edx)
80104264:	83 db ff             	sbb    $0xffffffff,%ebx
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104267:	81 c2 84 00 00 00    	add    $0x84,%edx
8010426d:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104273:	72 eb                	jb     80104260 <get_num_proc+0x20>
	}
	release(&ptable.lock);
80104275:	83 ec 0c             	sub    $0xc,%esp
80104278:	68 20 2d 11 80       	push   $0x80112d20
8010427d:	e8 be 04 00 00       	call   80104740 <release>

	return proc_cnt;
}
80104282:	89 d8                	mov    %ebx,%eax
80104284:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104287:	c9                   	leave  
80104288:	c3                   	ret    
80104289:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80104290 <get_max_pid>:
	int 
get_max_pid(void)
{
...
8010429e:	e8 dd 03 00 00       	call   80104680 <acquire>
...
801042b0:	8b 42 10             	mov    0x10(%edx),%eax
801042b3:	39 c3                	cmp    %eax,%ebx
801042b5:	0f 4c d8             	cmovl  %eax,%ebx
801042b8:	81 c2 84 00 00 00    	add    $0x84,%edx
801042be:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801042c4:	72 ea                	jb     801042b0 <get_max_pid+0x20>
		if(p -> pid > max_pid)
			max_pid = p -> pid;
	}
	release(&ptable.lock);
...
801042ce:	e8 6d 04 00 00       	call   80104740 <release>

	return max_pid;
}
801042d3:	89 d8                	mov    %ebx,%eax
801042d5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801042d8:	c9                   	leave  
801042d9:	c3                   	ret    
801042da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801042e0 <get_proc_info>:
...
801042f3:	e8 88 03 00 00       	call   80104680 <acquire>
801042f8:	83 c4 10             	add    $0x10,%esp
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042fb:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104300:	eb 12                	jmp    80104314 <get_proc_info+0x34>
80104302:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104308:	05 84 00 00 00       	add    $0x84,%eax
8010430d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80104312:	73 4c                	jae    80104360 <get_proc_info+0x80>
		if(p->pid == pid){
80104314:	39 58 10             	cmp    %ebx,0x10(%eax)
80104317:	75 ef                	jne    80104308 <get_proc_info+0x28>

			//pid가 1일때 부모는 0으로 설정해준다
			if(pid == 1)
80104319:	83 fb 01             	cmp    $0x1,%ebx
8010431c:	74 32                	je     80104350 <get_proc_info+0x70>
				procInfo -> ppid = 0;
			else
				procInfo -> ppid = p->parent->pid;
8010431e:	8b 50 14             	mov    0x14(%eax),%edx
80104321:	8b 52 10             	mov    0x10(%edx),%edx
80104324:	89 16                	mov    %edx,(%esi)
			procInfo -> psize = p-> sz;
80104326:	8b 10                	mov    (%eax),%edx
			procInfo -> numberContextSwitches= p->switch_cnt;

			release(&ptable.lock);
80104328:	83 ec 0c             	sub    $0xc,%esp
			procInfo -> psize = p-> sz;
8010432b:	89 56 04             	mov    %edx,0x4(%esi)
			procInfo -> numberContextSwitches= p->switch_cnt;
8010432e:	8b 40 7c             	mov    0x7c(%eax),%eax
80104331:	89 46 08             	mov    %eax,0x8(%esi)
			release(&ptable.lock);
80104334:	68 20 2d 11 80       	push   $0x80112d20
80104339:	e8 02 04 00 00       	call   80104740 <release>
			return 0;
...
8010434a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
				procInfo -> ppid = 0;
80104350:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80104356:	eb ce                	jmp    80104326 <get_proc_info+0x46>
80104358:	90                   	nop
80104359:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	release(&ptable.lock);
80104360:	83 ec 0c             	sub    $0xc,%esp
80104363:	68 20 2d 11 80       	push   $0x80112d20
80104368:	e8 d3 03 00 00       	call   80104740 <release>
	return -1;
...
8010438c:	e8 ef 02 00 00       	call   80104680 <acquire>
	pushcli();
80104391:	e8 1a 02 00 00       	call   801045b0 <pushcli>
	c = mycpu();
80104396:	e8 d5 f3 ff ff       	call   80103770 <mycpu>
	p = c->proc;
8010439b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
801043a1:	e8 4a 02 00 00       	call   801045f0 <popcli>
	myproc()->priority = n;
801043a6:	8b 45 08             	mov    0x8(%ebp),%eax
801043a9:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	release(&ptable.lock);
801043af:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801043b6:	e8 85 03 00 00       	call   80104740 <release>
	return 0;
}
...
801043d4:	83 ec 10             	sub    $0x10,%esp
	int prio;
	acquire(&ptable.lock);
801043d7:	68 20 2d 11 80       	push   $0x80112d20
801043dc:	e8 9f 02 00 00       	call   80104680 <acquire>
	pushcli();
801043e1:	e8 ca 01 00 00       	call   801045b0 <pushcli>
	c = mycpu();
801043e6:	e8 85 f3 ff ff       	call   80103770 <mycpu>
	p = c->proc;
801043eb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
801043f1:	e8 fa 01 00 00       	call   801045f0 <popcli>
	prio = myproc() -> priority;	
801043f6:	8b 9b 80 00 00 00    	mov    0x80(%ebx),%ebx
	release(&ptable.lock);
801043fc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104403:	e8 38 03 00 00       	call   80104740 <release>
	return prio;
}
...
80104b84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b87:	e8 84 ec ff ff       	call   80103810 <myproc>
...
80104b97:	83 fa 1b             	cmp    $0x1b,%edx
...
80104d14:	68 90 7a 10 80       	push   $0x80107a90
...
80104d2c:	68 8f 7a 10 80       	push   $0x80107a8f
...
80104d45:	68 83 7a 10 80       	push   $0x80107a83
...
80104d5a:	68 92 7a 10 80       	push   $0x80107a92
80104d5f:	e8 2c b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d64:	83 ec 0c             	sub    $0xc,%esp
80104d67:	68 74 7a 10 80       	push   $0x80107a74
...
80104da4:	e8 67 ea ff ff       	call   80103810 <myproc>
...
80104de9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104deb:	e8 20 ea ff ff       	call   80103810 <myproc>
...
80104f33:	78 2b                	js     80104f60 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f35:	e8 d6 e8 ff ff       	call   80103810 <myproc>
...
80105159:	58                   	pop    %eax
8010515a:	5a                   	pop    %edx
8010515b:	68 90 7a 10 80       	push   $0x80107a90
...
80105174:	68 8f 7a 10 80       	push   $0x80107a8f
...
8010536f:	0f 84 a6 00 00 00    	je     8010541b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105375:	e8 96 e4 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105545:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105548:	e8 c3 e2 ff ff       	call   80103810 <myproc>
...
8010571f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105721:	e8 ea e0 ff ff       	call   80103810 <myproc>
...
80105747:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010574a:	e8 c1 e0 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057c3:	5d                   	pop    %ebp
  return fork();
801057c4:	e9 e7 e1 ff ff       	jmp    801039b0 <fork>
...
801057e3:	5d                   	pop    %ebp
  return wait();
801057e4:	e9 a7 e7 ff ff       	jmp    80103f90 <wait>
...
80105833:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105836:	e8 d5 df ff ff       	call   80103810 <myproc>
...
80105857:	78 27                	js     80105880 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105859:	e8 b2 df ff ff       	call   80103810 <myproc>
  if(growproc(n) < 0)
...
80105866:	e8 c5 e0 ff ff       	call   80103930 <growproc>
...
801058dd:	e8 ee e5 ff ff       	call   80103ed0 <sleep>
  while(ticks - ticks0 < n){
...
801058ef:	73 2f                	jae    80105920 <sys_sleep+0x90>
    if(myproc()->killed){
801058f1:	e8 1a df ff ff       	call   80103810 <myproc>
...
80105973:	83 ec 14             	sub    $0x14,%esp
	...
	cprintf("helloxv6\n");
80105976:	68 d5 7a 10 80       	push   $0x80107ad5
...
8010599c:	e8 9f f1 ff ff       	call   80104b40 <argstr>
801059a1:	83 c4 10             	add    $0x10,%esp
801059a4:	85 c0                	test   %eax,%eax
801059a6:	78 18                	js     801059c0 <sys_hello_name+0x30>
		return -1;
	cprintf("hello %s\n", name);
801059a8:	83 ec 08             	sub    $0x8,%esp
801059ab:	ff 75 f4             	pushl  -0xc(%ebp)
801059ae:	68 df 7a 10 80       	push   $0x80107adf
801059b3:	e8 a8 ac ff ff       	call   80100660 <cprintf>
...
801059d3:	5d                   	pop    %ebp
	return get_num_proc();
801059d4:	e9 67 e8 ff ff       	jmp    80104240 <get_num_proc>
801059d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801059e0 <sys_get_max_pid>:
int
...
801059e3:	5d                   	pop    %ebp
	return get_max_pid();
801059e4:	e9 a7 e8 ff ff       	jmp    80104290 <get_max_pid>
801059e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801059f0 <sys_get_proc_info>:
int
...
80105a4c:	e8 3f f0 ff ff       	call   80104a90 <argint>
80105a51:	83 c4 10             	add    $0x10,%esp
80105a54:	85 c0                	test   %eax,%eax
80105a56:	78 18                	js     80105a70 <sys_set_prio+0x30>
		return -1;
	return set_prio(n);
80105a58:	83 ec 0c             	sub    $0xc,%esp
80105a5b:	ff 75 f4             	pushl  -0xc(%ebp)
80105a5e:	e8 1d e9 ff ff       	call   80104380 <set_prio>
...
80105a83:	5d                   	pop    %ebp
	return get_prio();
80105a84:	e9 47 e9 ff ff       	jmp    801043d0 <get_prio>
...
80105a99:	e8 c2 00 00 00       	call   80105b60 <trap>
...
80105ac7:	c7 04 c5 a2 4e 11 80 	movl   $0x8e000008,-0x7feeb15e(,%eax,8)
80105ace:	08 00 00 8e 
80105ad2:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105ad9:	80 
80105ada:	c1 ea 10             	shr    $0x10,%edx
80105add:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
80105ae4:	80 
  for(i = 0; i < 256; i++)
...
80105af4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105af7:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
80105afe:	00 00 ef 
  initlock(&tickslock, "time");
80105b01:	68 e9 7a 10 80       	push   $0x80107ae9
80105b06:	68 60 4e 11 80       	push   $0x80114e60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b0b:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105b11:	c1 e8 10             	shr    $0x10,%eax
80105b14:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
...
80105b3b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b3f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105b80:	ff 24 85 90 7b 10 80 	jmp    *-0x7fef8470(,%eax,4)
...
80105be5:	68 4c 7b 10 80       	push   $0x80107b4c
...
80105c72:	0f 85 e8 00 00 00    	jne    80105d60 <trap+0x200>
    myproc()->tf = tf;
80105c78:	e8 93 db ff ff       	call   80103810 <myproc>
...
80105cdd:	e8 7e ca ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ce2:	e8 29 db ff ff       	call   80103810 <myproc>
...
80105cfd:	e8 5e ca ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d02:	e8 09 db ff ff       	call   80103810 <myproc>
...
80105d1f:	e8 cc da ff ff       	call   801037f0 <cpuid>
80105d24:	56                   	push   %esi
80105d25:	53                   	push   %ebx
80105d26:	50                   	push   %eax
80105d27:	68 f4 7a 10 80       	push   $0x80107af4
...
80105d36:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d39:	e8 d2 da ff ff       	call   80103810 <myproc>
...
80105d5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d60:	e8 eb df ff ff       	call   80103d50 <exit>
80105d65:	e9 0e ff ff ff       	jmp    80105c78 <trap+0x118>
80105d6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105d70:	e8 db df ff ff       	call   80103d50 <exit>
80105d75:	e9 aa fe ff ff       	jmp    80105c24 <trap+0xc4>
80105d7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105d80:	83 ec 0c             	sub    $0xc,%esp
80105d83:	68 60 4e 11 80       	push   $0x80114e60
80105d88:	e8 f3 e8 ff ff       	call   80104680 <acquire>
      wakeup(&ticks);
80105d8d:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105d94:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105d9b:	e8 f0 e2 ff ff       	call   80104090 <wakeup>
      release(&tickslock);
80105da0:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
...
80105db4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105db7:	e8 34 da ff ff       	call   801037f0 <cpuid>
...
80105dc5:	68 18 7b 10 80       	push   $0x80107b18
80105dca:	e8 91 a8 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105dcf:	83 c4 14             	add    $0x14,%esp
80105dd2:	68 ee 7a 10 80       	push   $0x80107aee
...
80105ecc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ecf:	bb 10 7c 10 80       	mov    $0x80107c10,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105f67:	6a 00                	push   $0x0
  jmp alltraps
80105f69:	e9 1b fb ff ff       	jmp    80105a89 <alltraps>
...
80105f70:	6a 01                	push   $0x1
  jmp alltraps
80105f72:	e9 12 fb ff ff       	jmp    80105a89 <alltraps>
...
80105f79:	6a 02                	push   $0x2
  jmp alltraps
80105f7b:	e9 09 fb ff ff       	jmp    80105a89 <alltraps>
...
80105f82:	6a 03                	push   $0x3
  jmp alltraps
80105f84:	e9 00 fb ff ff       	jmp    80105a89 <alltraps>
...
80105f8b:	6a 04                	push   $0x4
  jmp alltraps
80105f8d:	e9 f7 fa ff ff       	jmp    80105a89 <alltraps>
...
80105f94:	6a 05                	push   $0x5
  jmp alltraps
80105f96:	e9 ee fa ff ff       	jmp    80105a89 <alltraps>
...
80105f9d:	6a 06                	push   $0x6
  jmp alltraps
80105f9f:	e9 e5 fa ff ff       	jmp    80105a89 <alltraps>
...
80105fa6:	6a 07                	push   $0x7
  jmp alltraps
80105fa8:	e9 dc fa ff ff       	jmp    80105a89 <alltraps>
...
80105fad:	6a 08                	push   $0x8
  jmp alltraps
80105faf:	e9 d5 fa ff ff       	jmp    80105a89 <alltraps>
...
80105fb6:	6a 09                	push   $0x9
  jmp alltraps
80105fb8:	e9 cc fa ff ff       	jmp    80105a89 <alltraps>
...
80105fbd:	6a 0a                	push   $0xa
  jmp alltraps
80105fbf:	e9 c5 fa ff ff       	jmp    80105a89 <alltraps>
...
80105fc4:	6a 0b                	push   $0xb
  jmp alltraps
80105fc6:	e9 be fa ff ff       	jmp    80105a89 <alltraps>
...
80105fcb:	6a 0c                	push   $0xc
  jmp alltraps
80105fcd:	e9 b7 fa ff ff       	jmp    80105a89 <alltraps>
...
80105fd2:	6a 0d                	push   $0xd
  jmp alltraps
80105fd4:	e9 b0 fa ff ff       	jmp    80105a89 <alltraps>
...
80105fd9:	6a 0e                	push   $0xe
  jmp alltraps
80105fdb:	e9 a9 fa ff ff       	jmp    80105a89 <alltraps>
...
80105fe2:	6a 0f                	push   $0xf
  jmp alltraps
80105fe4:	e9 a0 fa ff ff       	jmp    80105a89 <alltraps>
...
80105feb:	6a 10                	push   $0x10
  jmp alltraps
80105fed:	e9 97 fa ff ff       	jmp    80105a89 <alltraps>
...
80105ff2:	6a 11                	push   $0x11
  jmp alltraps
80105ff4:	e9 90 fa ff ff       	jmp    80105a89 <alltraps>
...
80105ffb:	6a 12                	push   $0x12
  jmp alltraps
80105ffd:	e9 87 fa ff ff       	jmp    80105a89 <alltraps>
...
80106004:	6a 13                	push   $0x13
  jmp alltraps
80106006:	e9 7e fa ff ff       	jmp    80105a89 <alltraps>
...
8010600d:	6a 14                	push   $0x14
  jmp alltraps
8010600f:	e9 75 fa ff ff       	jmp    80105a89 <alltraps>
...
80106016:	6a 15                	push   $0x15
  jmp alltraps
80106018:	e9 6c fa ff ff       	jmp    80105a89 <alltraps>
...
8010601f:	6a 16                	push   $0x16
  jmp alltraps
80106021:	e9 63 fa ff ff       	jmp    80105a89 <alltraps>
...
80106028:	6a 17                	push   $0x17
  jmp alltraps
8010602a:	e9 5a fa ff ff       	jmp    80105a89 <alltraps>
...
80106031:	6a 18                	push   $0x18
  jmp alltraps
80106033:	e9 51 fa ff ff       	jmp    80105a89 <alltraps>
...
8010603a:	6a 19                	push   $0x19
  jmp alltraps
8010603c:	e9 48 fa ff ff       	jmp    80105a89 <alltraps>
...
80106043:	6a 1a                	push   $0x1a
  jmp alltraps
80106045:	e9 3f fa ff ff       	jmp    80105a89 <alltraps>
...
8010604c:	6a 1b                	push   $0x1b
  jmp alltraps
8010604e:	e9 36 fa ff ff       	jmp    80105a89 <alltraps>
...
80106055:	6a 1c                	push   $0x1c
  jmp alltraps
80106057:	e9 2d fa ff ff       	jmp    80105a89 <alltraps>
...
8010605e:	6a 1d                	push   $0x1d
  jmp alltraps
80106060:	e9 24 fa ff ff       	jmp    80105a89 <alltraps>
...
80106067:	6a 1e                	push   $0x1e
  jmp alltraps
80106069:	e9 1b fa ff ff       	jmp    80105a89 <alltraps>
...
80106070:	6a 1f                	push   $0x1f
  jmp alltraps
80106072:	e9 12 fa ff ff       	jmp    80105a89 <alltraps>
...
80106079:	6a 20                	push   $0x20
  jmp alltraps
8010607b:	e9 09 fa ff ff       	jmp    80105a89 <alltraps>
...
80106082:	6a 21                	push   $0x21
  jmp alltraps
80106084:	e9 00 fa ff ff       	jmp    80105a89 <alltraps>
...
8010608b:	6a 22                	push   $0x22
  jmp alltraps
8010608d:	e9 f7 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106094:	6a 23                	push   $0x23
  jmp alltraps
80106096:	e9 ee f9 ff ff       	jmp    80105a89 <alltraps>
...
8010609d:	6a 24                	push   $0x24
  jmp alltraps
8010609f:	e9 e5 f9 ff ff       	jmp    80105a89 <alltraps>
...
801060a6:	6a 25                	push   $0x25
  jmp alltraps
801060a8:	e9 dc f9 ff ff       	jmp    80105a89 <alltraps>
...
801060af:	6a 26                	push   $0x26
  jmp alltraps
801060b1:	e9 d3 f9 ff ff       	jmp    80105a89 <alltraps>
...
801060b8:	6a 27                	push   $0x27
  jmp alltraps
801060ba:	e9 ca f9 ff ff       	jmp    80105a89 <alltraps>
...
801060c1:	6a 28                	push   $0x28
  jmp alltraps
801060c3:	e9 c1 f9 ff ff       	jmp    80105a89 <alltraps>
...
801060ca:	6a 29                	push   $0x29
  jmp alltraps
801060cc:	e9 b8 f9 ff ff       	jmp    80105a89 <alltraps>
...
801060d3:	6a 2a                	push   $0x2a
  jmp alltraps
801060d5:	e9 af f9 ff ff       	jmp    80105a89 <alltraps>
...
801060dc:	6a 2b                	push   $0x2b
  jmp alltraps
801060de:	e9 a6 f9 ff ff       	jmp    80105a89 <alltraps>
...
801060e5:	6a 2c                	push   $0x2c
  jmp alltraps
801060e7:	e9 9d f9 ff ff       	jmp    80105a89 <alltraps>
...
801060ee:	6a 2d                	push   $0x2d
  jmp alltraps
801060f0:	e9 94 f9 ff ff       	jmp    80105a89 <alltraps>
...
801060f7:	6a 2e                	push   $0x2e
  jmp alltraps
801060f9:	e9 8b f9 ff ff       	jmp    80105a89 <alltraps>
...
80106100:	6a 2f                	push   $0x2f
  jmp alltraps
80106102:	e9 82 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106109:	6a 30                	push   $0x30
  jmp alltraps
8010610b:	e9 79 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106112:	6a 31                	push   $0x31
  jmp alltraps
80106114:	e9 70 f9 ff ff       	jmp    80105a89 <alltraps>
...
8010611b:	6a 32                	push   $0x32
  jmp alltraps
8010611d:	e9 67 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106124:	6a 33                	push   $0x33
  jmp alltraps
80106126:	e9 5e f9 ff ff       	jmp    80105a89 <alltraps>
...
8010612d:	6a 34                	push   $0x34
  jmp alltraps
8010612f:	e9 55 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106136:	6a 35                	push   $0x35
  jmp alltraps
80106138:	e9 4c f9 ff ff       	jmp    80105a89 <alltraps>
...
8010613f:	6a 36                	push   $0x36
  jmp alltraps
80106141:	e9 43 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106148:	6a 37                	push   $0x37
  jmp alltraps
8010614a:	e9 3a f9 ff ff       	jmp    80105a89 <alltraps>
...
80106151:	6a 38                	push   $0x38
  jmp alltraps
80106153:	e9 31 f9 ff ff       	jmp    80105a89 <alltraps>
...
8010615a:	6a 39                	push   $0x39
  jmp alltraps
8010615c:	e9 28 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106163:	6a 3a                	push   $0x3a
  jmp alltraps
80106165:	e9 1f f9 ff ff       	jmp    80105a89 <alltraps>
...
8010616c:	6a 3b                	push   $0x3b
  jmp alltraps
8010616e:	e9 16 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106175:	6a 3c                	push   $0x3c
  jmp alltraps
80106177:	e9 0d f9 ff ff       	jmp    80105a89 <alltraps>
...
8010617e:	6a 3d                	push   $0x3d
  jmp alltraps
80106180:	e9 04 f9 ff ff       	jmp    80105a89 <alltraps>
...
80106187:	6a 3e                	push   $0x3e
  jmp alltraps
80106189:	e9 fb f8 ff ff       	jmp    80105a89 <alltraps>
...
80106190:	6a 3f                	push   $0x3f
  jmp alltraps
80106192:	e9 f2 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106199:	6a 40                	push   $0x40
  jmp alltraps
8010619b:	e9 e9 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061a2:	6a 41                	push   $0x41
  jmp alltraps
801061a4:	e9 e0 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061ab:	6a 42                	push   $0x42
  jmp alltraps
801061ad:	e9 d7 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061b4:	6a 43                	push   $0x43
  jmp alltraps
801061b6:	e9 ce f8 ff ff       	jmp    80105a89 <alltraps>
...
801061bd:	6a 44                	push   $0x44
  jmp alltraps
801061bf:	e9 c5 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061c6:	6a 45                	push   $0x45
  jmp alltraps
801061c8:	e9 bc f8 ff ff       	jmp    80105a89 <alltraps>
...
801061cf:	6a 46                	push   $0x46
  jmp alltraps
801061d1:	e9 b3 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061d8:	6a 47                	push   $0x47
  jmp alltraps
801061da:	e9 aa f8 ff ff       	jmp    80105a89 <alltraps>
...
801061e1:	6a 48                	push   $0x48
  jmp alltraps
801061e3:	e9 a1 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061ea:	6a 49                	push   $0x49
  jmp alltraps
801061ec:	e9 98 f8 ff ff       	jmp    80105a89 <alltraps>
...
801061f3:	6a 4a                	push   $0x4a
  jmp alltraps
801061f5:	e9 8f f8 ff ff       	jmp    80105a89 <alltraps>
...
801061fc:	6a 4b                	push   $0x4b
  jmp alltraps
801061fe:	e9 86 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106205:	6a 4c                	push   $0x4c
  jmp alltraps
80106207:	e9 7d f8 ff ff       	jmp    80105a89 <alltraps>
...
8010620e:	6a 4d                	push   $0x4d
  jmp alltraps
80106210:	e9 74 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106217:	6a 4e                	push   $0x4e
  jmp alltraps
80106219:	e9 6b f8 ff ff       	jmp    80105a89 <alltraps>
...
80106220:	6a 4f                	push   $0x4f
  jmp alltraps
80106222:	e9 62 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106229:	6a 50                	push   $0x50
  jmp alltraps
8010622b:	e9 59 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106232:	6a 51                	push   $0x51
  jmp alltraps
80106234:	e9 50 f8 ff ff       	jmp    80105a89 <alltraps>
...
8010623b:	6a 52                	push   $0x52
  jmp alltraps
8010623d:	e9 47 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106244:	6a 53                	push   $0x53
  jmp alltraps
80106246:	e9 3e f8 ff ff       	jmp    80105a89 <alltraps>
...
8010624d:	6a 54                	push   $0x54
  jmp alltraps
8010624f:	e9 35 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106256:	6a 55                	push   $0x55
  jmp alltraps
80106258:	e9 2c f8 ff ff       	jmp    80105a89 <alltraps>
...
8010625f:	6a 56                	push   $0x56
  jmp alltraps
80106261:	e9 23 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106268:	6a 57                	push   $0x57
  jmp alltraps
8010626a:	e9 1a f8 ff ff       	jmp    80105a89 <alltraps>
...
80106271:	6a 58                	push   $0x58
  jmp alltraps
80106273:	e9 11 f8 ff ff       	jmp    80105a89 <alltraps>
...
8010627a:	6a 59                	push   $0x59
  jmp alltraps
8010627c:	e9 08 f8 ff ff       	jmp    80105a89 <alltraps>
...
80106283:	6a 5a                	push   $0x5a
  jmp alltraps
80106285:	e9 ff f7 ff ff       	jmp    80105a89 <alltraps>
...
8010628c:	6a 5b                	push   $0x5b
  jmp alltraps
8010628e:	e9 f6 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106295:	6a 5c                	push   $0x5c
  jmp alltraps
80106297:	e9 ed f7 ff ff       	jmp    80105a89 <alltraps>
...
8010629e:	6a 5d                	push   $0x5d
  jmp alltraps
801062a0:	e9 e4 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062a7:	6a 5e                	push   $0x5e
  jmp alltraps
801062a9:	e9 db f7 ff ff       	jmp    80105a89 <alltraps>
...
801062b0:	6a 5f                	push   $0x5f
  jmp alltraps
801062b2:	e9 d2 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062b9:	6a 60                	push   $0x60
  jmp alltraps
801062bb:	e9 c9 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062c2:	6a 61                	push   $0x61
  jmp alltraps
801062c4:	e9 c0 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062cb:	6a 62                	push   $0x62
  jmp alltraps
801062cd:	e9 b7 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062d4:	6a 63                	push   $0x63
  jmp alltraps
801062d6:	e9 ae f7 ff ff       	jmp    80105a89 <alltraps>
...
801062dd:	6a 64                	push   $0x64
  jmp alltraps
801062df:	e9 a5 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062e6:	6a 65                	push   $0x65
  jmp alltraps
801062e8:	e9 9c f7 ff ff       	jmp    80105a89 <alltraps>
...
801062ef:	6a 66                	push   $0x66
  jmp alltraps
801062f1:	e9 93 f7 ff ff       	jmp    80105a89 <alltraps>
...
801062f8:	6a 67                	push   $0x67
  jmp alltraps
801062fa:	e9 8a f7 ff ff       	jmp    80105a89 <alltraps>
...
80106301:	6a 68                	push   $0x68
  jmp alltraps
80106303:	e9 81 f7 ff ff       	jmp    80105a89 <alltraps>
...
8010630a:	6a 69                	push   $0x69
  jmp alltraps
8010630c:	e9 78 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106313:	6a 6a                	push   $0x6a
  jmp alltraps
80106315:	e9 6f f7 ff ff       	jmp    80105a89 <alltraps>
...
8010631c:	6a 6b                	push   $0x6b
  jmp alltraps
8010631e:	e9 66 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106325:	6a 6c                	push   $0x6c
  jmp alltraps
80106327:	e9 5d f7 ff ff       	jmp    80105a89 <alltraps>
...
8010632e:	6a 6d                	push   $0x6d
  jmp alltraps
80106330:	e9 54 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106337:	6a 6e                	push   $0x6e
  jmp alltraps
80106339:	e9 4b f7 ff ff       	jmp    80105a89 <alltraps>
...
80106340:	6a 6f                	push   $0x6f
  jmp alltraps
80106342:	e9 42 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106349:	6a 70                	push   $0x70
  jmp alltraps
8010634b:	e9 39 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106352:	6a 71                	push   $0x71
  jmp alltraps
80106354:	e9 30 f7 ff ff       	jmp    80105a89 <alltraps>
...
8010635b:	6a 72                	push   $0x72
  jmp alltraps
8010635d:	e9 27 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106364:	6a 73                	push   $0x73
  jmp alltraps
80106366:	e9 1e f7 ff ff       	jmp    80105a89 <alltraps>
...
8010636d:	6a 74                	push   $0x74
  jmp alltraps
8010636f:	e9 15 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106376:	6a 75                	push   $0x75
  jmp alltraps
80106378:	e9 0c f7 ff ff       	jmp    80105a89 <alltraps>
...
8010637f:	6a 76                	push   $0x76
  jmp alltraps
80106381:	e9 03 f7 ff ff       	jmp    80105a89 <alltraps>
...
80106388:	6a 77                	push   $0x77
  jmp alltraps
8010638a:	e9 fa f6 ff ff       	jmp    80105a89 <alltraps>
...
80106391:	6a 78                	push   $0x78
  jmp alltraps
80106393:	e9 f1 f6 ff ff       	jmp    80105a89 <alltraps>
...
8010639a:	6a 79                	push   $0x79
  jmp alltraps
8010639c:	e9 e8 f6 ff ff       	jmp    80105a89 <alltraps>
...
801063a3:	6a 7a                	push   $0x7a
  jmp alltraps
801063a5:	e9 df f6 ff ff       	jmp    80105a89 <alltraps>
...
801063ac:	6a 7b                	push   $0x7b
  jmp alltraps
801063ae:	e9 d6 f6 ff ff       	jmp    80105a89 <alltraps>
...
801063b5:	6a 7c                	push   $0x7c
  jmp alltraps
801063b7:	e9 cd f6 ff ff       	jmp    80105a89 <alltraps>
...
801063be:	6a 7d                	push   $0x7d
  jmp alltraps
801063c0:	e9 c4 f6 ff ff       	jmp    80105a89 <alltraps>
...
801063c7:	6a 7e                	push   $0x7e
  jmp alltraps
801063c9:	e9 bb f6 ff ff       	jmp    80105a89 <alltraps>
...
801063d0:	6a 7f                	push   $0x7f
  jmp alltraps
801063d2:	e9 b2 f6 ff ff       	jmp    80105a89 <alltraps>
...
801063d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063de:	e9 a6 f6 ff ff       	jmp    80105a89 <alltraps>
...
801063e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063ea:	e9 9a f6 ff ff       	jmp    80105a89 <alltraps>
...
801063f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063f6:	e9 8e f6 ff ff       	jmp    80105a89 <alltraps>
...
801063fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106402:	e9 82 f6 ff ff       	jmp    80105a89 <alltraps>
...
80106409:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010640e:	e9 76 f6 ff ff       	jmp    80105a89 <alltraps>
...
80106415:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010641a:	e9 6a f6 ff ff       	jmp    80105a89 <alltraps>
...
80106421:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106426:	e9 5e f6 ff ff       	jmp    80105a89 <alltraps>
...
8010642d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106432:	e9 52 f6 ff ff       	jmp    80105a89 <alltraps>
...
80106439:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010643e:	e9 46 f6 ff ff       	jmp    80105a89 <alltraps>
...
80106445:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010644a:	e9 3a f6 ff ff       	jmp    80105a89 <alltraps>
...
80106451:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106456:	e9 2e f6 ff ff       	jmp    80105a89 <alltraps>
...
8010645d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106462:	e9 22 f6 ff ff       	jmp    80105a89 <alltraps>
...
80106469:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010646e:	e9 16 f6 ff ff       	jmp    80105a89 <alltraps>
...
80106475:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010647a:	e9 0a f6 ff ff       	jmp    80105a89 <alltraps>
...
80106481:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106486:	e9 fe f5 ff ff       	jmp    80105a89 <alltraps>
...
8010648d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106492:	e9 f2 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106499:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010649e:	e9 e6 f5 ff ff       	jmp    80105a89 <alltraps>
...
801064a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801064aa:	e9 da f5 ff ff       	jmp    80105a89 <alltraps>
...
801064b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064b6:	e9 ce f5 ff ff       	jmp    80105a89 <alltraps>
...
801064bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064c2:	e9 c2 f5 ff ff       	jmp    80105a89 <alltraps>
...
801064c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064ce:	e9 b6 f5 ff ff       	jmp    80105a89 <alltraps>
...
801064d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064da:	e9 aa f5 ff ff       	jmp    80105a89 <alltraps>
...
801064e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064e6:	e9 9e f5 ff ff       	jmp    80105a89 <alltraps>
...
801064ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064f2:	e9 92 f5 ff ff       	jmp    80105a89 <alltraps>
...
801064f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064fe:	e9 86 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106505:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010650a:	e9 7a f5 ff ff       	jmp    80105a89 <alltraps>
...
80106511:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106516:	e9 6e f5 ff ff       	jmp    80105a89 <alltraps>
...
8010651d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106522:	e9 62 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106529:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010652e:	e9 56 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106535:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010653a:	e9 4a f5 ff ff       	jmp    80105a89 <alltraps>
...
80106541:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106546:	e9 3e f5 ff ff       	jmp    80105a89 <alltraps>
...
8010654d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106552:	e9 32 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106559:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010655e:	e9 26 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106565:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010656a:	e9 1a f5 ff ff       	jmp    80105a89 <alltraps>
...
80106571:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106576:	e9 0e f5 ff ff       	jmp    80105a89 <alltraps>
...
8010657d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106582:	e9 02 f5 ff ff       	jmp    80105a89 <alltraps>
...
80106589:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010658e:	e9 f6 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106595:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010659a:	e9 ea f4 ff ff       	jmp    80105a89 <alltraps>
...
801065a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801065a6:	e9 de f4 ff ff       	jmp    80105a89 <alltraps>
...
801065ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065b2:	e9 d2 f4 ff ff       	jmp    80105a89 <alltraps>
...
801065b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065be:	e9 c6 f4 ff ff       	jmp    80105a89 <alltraps>
...
801065c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065ca:	e9 ba f4 ff ff       	jmp    80105a89 <alltraps>
...
801065d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065d6:	e9 ae f4 ff ff       	jmp    80105a89 <alltraps>
...
801065dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065e2:	e9 a2 f4 ff ff       	jmp    80105a89 <alltraps>
...
801065e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ee:	e9 96 f4 ff ff       	jmp    80105a89 <alltraps>
...
801065f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065fa:	e9 8a f4 ff ff       	jmp    80105a89 <alltraps>
...
80106601:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106606:	e9 7e f4 ff ff       	jmp    80105a89 <alltraps>
...
8010660d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106612:	e9 72 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106619:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010661e:	e9 66 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106625:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010662a:	e9 5a f4 ff ff       	jmp    80105a89 <alltraps>
...
80106631:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106636:	e9 4e f4 ff ff       	jmp    80105a89 <alltraps>
...
8010663d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106642:	e9 42 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106649:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010664e:	e9 36 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106655:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010665a:	e9 2a f4 ff ff       	jmp    80105a89 <alltraps>
...
80106661:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106666:	e9 1e f4 ff ff       	jmp    80105a89 <alltraps>
...
8010666d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106672:	e9 12 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106679:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010667e:	e9 06 f4 ff ff       	jmp    80105a89 <alltraps>
...
80106685:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010668a:	e9 fa f3 ff ff       	jmp    80105a89 <alltraps>
...
80106691:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106696:	e9 ee f3 ff ff       	jmp    80105a89 <alltraps>
...
8010669d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801066a2:	e9 e2 f3 ff ff       	jmp    80105a89 <alltraps>
...
801066a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801066ae:	e9 d6 f3 ff ff       	jmp    80105a89 <alltraps>
...
801066b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066ba:	e9 ca f3 ff ff       	jmp    80105a89 <alltraps>
...
801066c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066c6:	e9 be f3 ff ff       	jmp    80105a89 <alltraps>
...
801066cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066d2:	e9 b2 f3 ff ff       	jmp    80105a89 <alltraps>
...
801066d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066de:	e9 a6 f3 ff ff       	jmp    80105a89 <alltraps>
...
801066e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066ea:	e9 9a f3 ff ff       	jmp    80105a89 <alltraps>
...
801066f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066f6:	e9 8e f3 ff ff       	jmp    80105a89 <alltraps>
...
801066fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106702:	e9 82 f3 ff ff       	jmp    80105a89 <alltraps>
...
80106709:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010670e:	e9 76 f3 ff ff       	jmp    80105a89 <alltraps>
...
80106715:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010671a:	e9 6a f3 ff ff       	jmp    80105a89 <alltraps>
...
80106721:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106726:	e9 5e f3 ff ff       	jmp    80105a89 <alltraps>
...
8010672d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106732:	e9 52 f3 ff ff       	jmp    80105a89 <alltraps>
...
80106739:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010673e:	e9 46 f3 ff ff       	jmp    80105a89 <alltraps>
...
80106745:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010674a:	e9 3a f3 ff ff       	jmp    80105a89 <alltraps>
...
80106751:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106756:	e9 2e f3 ff ff       	jmp    80105a89 <alltraps>
...
8010675d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106762:	e9 22 f3 ff ff       	jmp    80105a89 <alltraps>
...
80106769:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010676e:	e9 16 f3 ff ff       	jmp    80105a89 <alltraps>
...
80106775:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010677a:	e9 0a f3 ff ff       	jmp    80105a89 <alltraps>
...
80106781:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106786:	e9 fe f2 ff ff       	jmp    80105a89 <alltraps>
...
8010678d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106792:	e9 f2 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106799:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010679e:	e9 e6 f2 ff ff       	jmp    80105a89 <alltraps>
...
801067a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801067aa:	e9 da f2 ff ff       	jmp    80105a89 <alltraps>
...
801067b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067b6:	e9 ce f2 ff ff       	jmp    80105a89 <alltraps>
...
801067bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067c2:	e9 c2 f2 ff ff       	jmp    80105a89 <alltraps>
...
801067c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067ce:	e9 b6 f2 ff ff       	jmp    80105a89 <alltraps>
...
801067d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067da:	e9 aa f2 ff ff       	jmp    80105a89 <alltraps>
...
801067e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067e6:	e9 9e f2 ff ff       	jmp    80105a89 <alltraps>
...
801067ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067f2:	e9 92 f2 ff ff       	jmp    80105a89 <alltraps>
...
801067f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067fe:	e9 86 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106805:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010680a:	e9 7a f2 ff ff       	jmp    80105a89 <alltraps>
...
80106811:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106816:	e9 6e f2 ff ff       	jmp    80105a89 <alltraps>
...
8010681d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106822:	e9 62 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106829:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010682e:	e9 56 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106835:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010683a:	e9 4a f2 ff ff       	jmp    80105a89 <alltraps>
...
80106841:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106846:	e9 3e f2 ff ff       	jmp    80105a89 <alltraps>
...
8010684d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106852:	e9 32 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106859:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010685e:	e9 26 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106865:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010686a:	e9 1a f2 ff ff       	jmp    80105a89 <alltraps>
...
80106871:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106876:	e9 0e f2 ff ff       	jmp    80105a89 <alltraps>
...
8010687d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106882:	e9 02 f2 ff ff       	jmp    80105a89 <alltraps>
...
80106889:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010688e:	e9 f6 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106895:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010689a:	e9 ea f1 ff ff       	jmp    80105a89 <alltraps>
...
801068a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801068a6:	e9 de f1 ff ff       	jmp    80105a89 <alltraps>
...
801068ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068b2:	e9 d2 f1 ff ff       	jmp    80105a89 <alltraps>
...
801068b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068be:	e9 c6 f1 ff ff       	jmp    80105a89 <alltraps>
...
801068c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068ca:	e9 ba f1 ff ff       	jmp    80105a89 <alltraps>
...
801068d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068d6:	e9 ae f1 ff ff       	jmp    80105a89 <alltraps>
...
801068dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068e2:	e9 a2 f1 ff ff       	jmp    80105a89 <alltraps>
...
801068e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ee:	e9 96 f1 ff ff       	jmp    80105a89 <alltraps>
...
801068f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068fa:	e9 8a f1 ff ff       	jmp    80105a89 <alltraps>
...
80106901:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106906:	e9 7e f1 ff ff       	jmp    80105a89 <alltraps>
...
8010690d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106912:	e9 72 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106919:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010691e:	e9 66 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106925:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010692a:	e9 5a f1 ff ff       	jmp    80105a89 <alltraps>
...
80106931:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106936:	e9 4e f1 ff ff       	jmp    80105a89 <alltraps>
...
8010693d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106942:	e9 42 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106949:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010694e:	e9 36 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106955:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010695a:	e9 2a f1 ff ff       	jmp    80105a89 <alltraps>
...
80106961:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106966:	e9 1e f1 ff ff       	jmp    80105a89 <alltraps>
...
8010696d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106972:	e9 12 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106979:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010697e:	e9 06 f1 ff ff       	jmp    80105a89 <alltraps>
...
80106985:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010698a:	e9 fa f0 ff ff       	jmp    80105a89 <alltraps>
...
80106991:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106996:	e9 ee f0 ff ff       	jmp    80105a89 <alltraps>
...
8010699d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801069a2:	e9 e2 f0 ff ff       	jmp    80105a89 <alltraps>
...
801069a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801069ae:	e9 d6 f0 ff ff       	jmp    80105a89 <alltraps>
...
801069b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069ba:	e9 ca f0 ff ff       	jmp    80105a89 <alltraps>
...
801069c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069c6:	e9 be f0 ff ff       	jmp    80105a89 <alltraps>
...
801069cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069d2:	e9 b2 f0 ff ff       	jmp    80105a89 <alltraps>
...
80106add:	68 18 7c 10 80       	push   $0x80107c18
...
80106b93:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b96:	e8 55 cc ff ff       	call   801037f0 <cpuid>
...
80106c20:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106c6f:	e8 fc ca ff ff       	call   80103770 <mycpu>
80106c74:	89 c6                	mov    %eax,%esi
80106c76:	e8 f5 ca ff ff       	call   80103770 <mycpu>
...
80106c88:	e8 e3 ca ff ff       	call   80103770 <mycpu>
...
80106db9:	68 5d 7c 10 80       	push   $0x80107c5d
...
80106f1d:	68 95 7c 10 80       	push   $0x80107c95
...
80106f53:	68 ad 7c 10 80       	push   $0x80107cad
...
8010705c:	68 c9 7c 10 80       	push   $0x80107cc9
...
801070fb:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010712f:	68 da 7c 10 80       	push   $0x80107cda
...
80107219:	68 fe 7c 10 80       	push   $0x80107cfe
8010721e:	e8 6d 91 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107223:	83 ec 0c             	sub    $0xc,%esp
80107226:	68 e4 7c 10 80       	push   $0x80107ce4
